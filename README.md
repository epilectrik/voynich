...
- 45 procedural chapters from the *Testamentum* (28 Mercuriorum + 17 Practica) match to ~28 folios, covering 85% of the expanded procedural content (53 chapters after reclassifying 6 higher Mercuriorum). 3 confirmed by independent structural evidence (f75r/Ch19, f76r/Ch18P, f84r/Ch14P); 5 via reverse-blind prediction; 3 via fch (mercury marker) hard-filter matching; the remainder at supported or speculative confidence
...
| Pseudo-Lullian source tradition | 45 procedural chapters → ~28 folios (85% of 53 procedural); 3 confirmed + 5 reverse-blind + 3 fch hard-filter + ~34 supported/speculative |
...
| 2 | **[RECIPE_MATCHING.md](RECIPE_MATCHING.md)** | How we matched 45 recipe chapters to ~28 folios — methods, validation, and full results |
...
| Recipe chapter coverage | 45 procedural chapters → ~28 folios (85% of *Testamentum* expanded procedural content) |
