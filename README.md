...
This conclusion rests on 1,968 validated constraints from 655 research phases across 37,957 tokens.
...
This project used AI-assisted computational analysis over 655 research phases. Every finding became a numbered constraint with an explicit confidence tier and provenance chain. Falsified hypotheses were permanently closed (Tier 1), they cannot be retried, preventing circular investigation. An embedded expert-advisor agent (carrying all 1,968 constraints) validates new findings against the full body of existing knowledge.
