...
**Core model: CLOSED** | **Characterization: ACTIVE** | **Version: 3.73**

| Metric | Value |
|--------|-------|
| Validated constraints | 888 |
| Research phases completed | 346 |
...
```
voynich/
  context/            # Constraint system (888 validated constraints)
  ...
  phases/             # 346 completed research phases
