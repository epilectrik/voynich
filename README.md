...
**Core model: CLOSED** | **Characterization: ACTIVE** | **Version: 3.72**

| Metric | Value |
|--------|-------|
| Validated constraints | 887 |
| Research phases completed | 345 |
...
```
voynich/
  context/            # Constraint system (887 validated constraints)
  ...
  phases/             # 345 completed research phases
