...
| Pseudo-Lullian source tradition | 51 procedural chapters → ~34 folios (96% of 53 procedural); 3 confirmed + 5 reverse-blind + 3 fch hard-filter + ~34 supported/speculative |
...
| 2 | **[RECIPE_MATCHING.md](RECIPE_MATCHING.md)** | How we matched 45 recipe chapters to ~34 folios — methods, validation, and full results |
...
| Recipe chapter coverage | 51 procedural chapters → ~34 folios (96% of *Testamentum* expanded procedural content) |
