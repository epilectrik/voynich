...
| C905-C955 | Various (FL, MIDDLE, section, vocabulary phases) |
| C956-C964 | B_TOKEN_LEVEL_SYNTAX |
| C965 | PARAGRAPH_STATE_COLLAPSE |
| C966-C970 | LANE_OSCILLATION_CONTROL_LAW |
| C971-C975 | FINGERPRINT_UNIQUENESS |
...
| C1005 | BUBBLE_POINT_OSCILLATION_TEST |
...
| C1014 | SURVIVOR_SET_GEOMETRY_ALIGNMENT |
