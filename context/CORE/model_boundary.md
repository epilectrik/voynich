...
| **Kernel Control** | 3 operators (k, h, e) with mandatory STATE-C | Phase 15: 0/100 surrogates reproduced |
| **Hazard Topology** | 17 forbidden transitions in 5 failure classes | Phase 18 |
| **Convergence** | Dominant convergence to STATE-C (57.8% terminal) | Phase 13-14, SEL-F |
...
| **Line = Micro-stage** | Lines are formal control blocks (3.3x more regular than random) | Phase LINE |
...
| **Cipher** | FALSIFIED | Phase G: transforms DECREASE MI |
...
| **Material Encoding** | FALSIFIED | Pure operational, 0 referent tokens |
...
| **What NOT to do** | Forbidden transitions (17 specific) |
| **When to wait** | LINK tokens (38% of text) |
| **Program organization** | Folio = complete program, Line = control block |
...
|--------|----------|--------------|
| **Currier B** | Sequential executable programs | Primary control content |
