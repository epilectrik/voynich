...
**Tier:** 2 | **Status:** CLOSED
HT density independent of LINK density at folio level (ρ=0.010, p=0.93). "More LINK = more doodling" is FALSIFIED.
**Source:** HTD
...
| HT = attentional pacing | 3 (interpretation) |
| HT = calligraphy practice | 4 (speculation) |
