...
The annotation system is stable (dual-lexicon H1 rho=0.744, H2 rho=0.842) and the Voynich response variables differentiate cells. The failure is in the bridge from historical closure demands to Voynich closure responses at the multi-cell level.

## What This Shows and Does Not Show

**Shows:** The frozen cell-to-method-class mapping (C494, C1247, C1248) does not transfer from thermal intensity alignment to closure-response alignment. H:R2 (SEALED_RECIRCULATION) comprehensively reverses predictions — highest sealed cell has lowest ey_rate and highest ii_rate. The cross-section bridge fails.

**Does NOT show:** That closure-response variables are uninformative for Brunschwig alignment. Individual safety axes within Stars show strong signal (ey p=0.0003, ii p=0.026 — see C1740). The failure is bridge-structural, not variable-quality. Alternative bridge designs (within-section only, different cell-to-class mapping, distributional rather than cell-mean) remain untested.
