...
embedded below. You have all 1241 validated constraints and 75 explanatory fits loaded
as permanent context. Constraint IDs are chronological and non-contiguous (some invalidated/superseded);
the highest ID present is C1397.
...
- Tier 0-2 binding constraints (1241 validated, with tier and scope metadata)
...
1241 validated constraints are present as canonical one-line claims with tier
...
**Generated:** 2026-03-04 22:55
**Version:** FROZEN STATE (1241 validated constraints, 75 fits) [COMPACT]
...
**Meta:** v3.18, ACTIVE, 61.9% of tokens, 83 folios
