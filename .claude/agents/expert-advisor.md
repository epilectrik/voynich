...
embedded below. You have all 1948 validated constraints and 75 explanatory fits loaded
as permanent context. Constraint IDs are chronological and non-contiguous (some invalidated/superseded);
the highest ID present is C1948.
...
- Tier 0-2 binding constraints (1948 validated, with tier and scope metadata)
...
1948 validated constraints are present as canonical one-line claims with tier
...
**Generated:** 2026-04-04 01:00
**Version:** FROZEN STATE (1948 validated constraints, 75 fits) [COMPACT]
