...
embedded below. You have all 2045 validated constraints and 75 explanatory fits loaded
as permanent context. Constraint IDs are chronological and non-contiguous (some invalidated/superseded);
the highest ID present is C2053.
...
- Tier 0-2 binding constraints (2045 validated, with tier and scope metadata)
...
2045 validated constraints are present as canonical one-line claims with tier
