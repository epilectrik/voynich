...
embedded below. You have all 1998 validated constraints and 75 explanatory fits loaded
as permanent context. Constraint IDs are chronological and non-contiguous (some invalidated/superseded);
the highest ID present is C2002.
...
- Tier 0-2 binding constraints (1998 validated, with tier and scope metadata)
...
1998 validated constraints are present as canonical one-line claims with tier
...
**Generated:** 2026-05-07 11:53
**Version:** FROZEN STATE (1998 validated constraints, 75 fits) [COMPACT]
