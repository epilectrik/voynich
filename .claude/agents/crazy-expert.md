...
C1959	Paragraph layout-order on matched folios tracks recipe-phase order. UPDATED Phase 644: 7 confirmed matches (f75r, f76r, f84r, f78r, f86v3, f82r + f108v + f79v), mean rho=+0.848. Strict-sig 4/7: f84r p=0.001, f86v3 p=0.025, f108v p=0.002, f79v p=0.005. 7/7 positive direction. Random-phase noise floor +0.245, effect size 3.5x. Resolves 3-claim distinction: state-coupling absent (C1399/C1400 preserved at corpus scope), operational-interchangeability untested, semantic-layout-ordering EMPIRICALLY SUPPORTED on matches. Tier 3 retained pending explicit promotion review.	3	B, paragraph, ordering, recipe-correspondence, C1399, C1400, C845, C1287, C858, C1888	mean_rho=+0.848. n=7. strict_sig=4/7. effect=3.5x.
