...
C1741	A2 profile categorical safety-style shift: A2 categorically shifts safety toward transformative (ii) over preventive (e→y). S3 A2 dummy coeff=-0.124, t=-5.31, p=1e-6, R²=0.579. A2 sb=-0.022 vs non-A2=0.096. Continuous forgivingness fails (P1 rho=-0.047 p=0.686; P2 F=0.457 p=0.506). Herbal A3 surgery recovers thermal signal: H(A3):R4=0.101>R3=0.032, p=0.021. Stars anchor: R1=0.122>R3=0.012, p=0.002. Mechanism profile-categorical not parametric	2	B, apparatus, safety, A2, profile, REGIME, Herbal, Stars, Brunschwig, C1739, C1740, C1639, C1732, C1733	S3_coeff=-0.124. S3_t=-5.31. S3_p=1e-6. S3_R2=0.579. S2_p=0.002. P3_p=0.021. P1_rho=-0.047. P2_F=0.457.
C1742	Closure authenticity modulates safety strategy: strong_close_fraction positively predicts safety_balance after section control. Folios with more strong closures sustain preventive safety; weak/counterfeitable closures shift to transformative rescue. Section-controlled partial Spearman rho=0.304, p=0.008 (n=76). Raw rho=0.010 p=0.932 — within-section only. DYE orthogonal (Stars p=0.204, all p=0.702). Two independent safety modulators: profile (discrete) and closure authenticity (continuous, within-section)	2	B, closure, safety, authenticity, strong_close_fraction, C1642, C1732, C1733, C1741	P4_rho=0.304. P4_p=0.008. raw_rho=0.010. S1a_p=0.204. S1b_p=0.702.
