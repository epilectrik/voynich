...
C2052	8D Matcher Theophilus Negative Control FAILS: Matcher is Generic, Not Alchemy-Specific. PHASE_718 (2026-05-20). Pre-registered test locked 2026-05-14 per sources/theophilus/README.md, executed first time 2026-05-20 via existing script _theophilus_negative_control.py. Theophilus De Diversis Artibus (~1120 CE, metalwork/glass/pigments — NOT alchemy) tested as negative control for 8D matcher producing C1971 + C1882-C1956 operational-correspondence family. Pre-registered criteria: C1 ≤2/30 confident matches observed 4/30 AMBIGUOUS, C2 mean ratio ≤1.10 observed 0.878 PASS, C3 permutation p ≥0.10 observed 0.0000 FAIL, C4 Section B concentration <40pct observed 53.3pct FAIL. 2 FAIL + 1 PASS + 1 AMBIGUOUS. Script verdict: FAIL — matcher generic, demote C1882-C1956 to structural-similarity. 30 Theophilus chapters → 32 REGIME_1 folios. 16/30 Theophilus matches land on same Voynich folios as Pseudo-Lull match list (f84r, f77v, f75r, f76v, f76r, f81v, f75v, f77r, f81r, f80v, f83r, f82r, f78r). Same folios attract both Codicillus AND Theophilus chapters at similar rates. Permutation test real mean ratio 0.878 vs random 0.612 p=0.0000. Matcher detects medieval procedural Latin structural attraction generically NOT alchemy-specifically. Both experts consulted, converge on: NOT blanket-demote 75 constraints; per-constraint triage; content claims (specific PL chapter→folio correspondence "Ch19=aqua vitae" Mercuriorum book mapping) → DEMOTE to Tier 3; structural claims (8D distance alignment topology feature-space geometry) → SURVIVE at Tier 2. Tier 0 unaffected. C2032 substrate quintet, C2042 atom-monocategorical unaffected. Operational reading SURVIVES at genre level (medieval craft procedure manual); DIES at domain-specific level (alchemy/distillation). C171 semantic ceiling re-confirmed at matcher level. Pattern: 4 failed mechanism interpretations this session (PHASE_711 parametric, PHASE_716 line-spanning + mode coherence, PHASE_718 alchemy-specificity) — "operational-specificity death zone" confirmed predictable. Per-constraint audit of C1971+C1882-C1956 queued as PHASE_719 candidate. Expert estimate: ~15-25 of ~75 constraints need demotion.	2	negative_control_FAIL, matcher_generic, alchemy_specificity_falsified, structural_attraction_survives, pre_registered_test, per_constraint_audit_queued, Tier_0_unaffected, C2042_unaffected, C2032_unaffected, operational_specificity_death_zone_confirmed, C1971, C171	n_theophilus_chapters=30. n_regime_1_folios=32. mean_distance=2.7165. mean_ratio=0.878. n_confident_matches=4. permutation_p=0.0000. section_b_concentration_pct=53.3. n_theophilus_on_PL_folios=16_of_30. C3_observed=0.0000_FAIL. C4_observed=53.3pct_FAIL. script_verdict=FAIL_matcher_generic. pre_registration_date=2026_05_14. first_run_date=2026_05_20. tier_0_unaffected=yes. C2032_unaffected=yes. C2042_unaffected=yes. C171_semantic_ceiling_reconfirmed=yes. per_constraint_audit_queued=PHASE_719. blanket_demotion_avoided=yes. triage_criterion=content_demote_structure_survive. session_failed_mechanism_count=4. operational_specificity_death_zone=confirmed. operational_reading_survives_genre_level=yes. operational_reading_dies_domain_specific=yes.
