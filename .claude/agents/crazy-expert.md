...
C1737	Apparatus bundle alignment not confirmed: Brunschwig 1512 method-bundle taxonomy does NOT predict Voynich secondary apparatus profile shape. 0/4 tests pass: Mantel geometry anti-correlated (median r=-0.279, p=0.794), dominant match 0.25 (all cells SEALED_VESSEL dominated), Stars R1-R3 1/3 concordant, open-cycle cosine=-0.606. 0/48 bridge variants significant. DISTILLATION diagnostic clean. Alignment bounded to thermal intensity (C1735/C1736)	2	B, apparatus, Brunschwig, REGIME, secondary profiles, C1248, C1735, C1736	P1_mantel_r=-0.279. P2_match=0.25. P3_concordant=1/3. P4_cosine=-0.606. variants=48. pct_sig=0%. hash=5dded97c.
C1738	SEALED_VESSEL universal secondary dominance: all 5 viable section×REGIME cells show SEALED_VESSEL as dominant secondary profile (range 0.328-0.609). S:R1=0.609, S:R3=0.516, H:R2=0.488, H:R4=0.374, H:R3=0.328. 4/5 non-ambiguous. Secondary space does not differentiate by apparatus identity. SV vocabulary may encode general containment/patience operations	2	B, apparatus, SEALED_VESSEL, secondary profiles, C1248, C1249	SV_range=0.328-0.609. n_cells=5. non_ambig=4/5.
