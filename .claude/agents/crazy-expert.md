...
6. Structural Contract Signatures (6 contracts)
...
**Version:** 5.19 | **Status:** FROZEN | **Constraints:** 1410 | **Date:** 2026-03-06
...
C131	**RETRACTED 2026-05-19** Originally "Role consistency LOW (23.8%, threshold >80%)" as DSL/language hypothesis falsifier. Audit findings: (a) value does not reproduce on H-filtered current data (23.8% -> 12.2%, pre-v2.42 transcriber bug); (b) observed 12.2% at within-line shuffle null mean 12.0% (z=+0.69, effect +0.3pp); (c) ">80% DSL signal" threshold was theoretical and code literally has `# Adjusted threshold` set to 0.5 post-hoc. Language falsification independently supported by C130 (0.19% reference rate, 26× separation), C132, C173, C2015/C2022/C2032 substrate quintet, C089/C503.c/C521 kernel. Methodology memory: feedback_made_up_threshold_audit.md.	1	B
...
C476	**RETRACTED 2026-05-19** Originally "Currier A achieves greedy-optimal coverage with 22.3%% FEWER hub tokens than greedy would require" (Tier 2, hub-rationing framing). Audit (phases/C476_AUDIT/): (1) "100%% coverage" tautological -- denominator = data. (2) Greedy uses alphabetical fallback when gain=0 after saturation -- spams hubs ('a','o','e' alphabetically early) as artifact not strategy. (3) Freq-matched has sampling-with-replacement issues on Zipfian. The "22.3pp hub savings" measured `sort(alphabetically_early)`, not coverage_optimization. Surviving 3.2× hub ENRICHMENT vs uniform (31.6%% vs 9.8%%) is DIRECTIONALLY OPPOSITE to "rationing" claim -- retract not demote. 4th distinct audit failure pattern (broken-baseline). Methodology memory: feedback_broken_baseline_audit.md. C478 flagged AUDIT_PENDING (inherits coverage-control framing). 2026-01-12 probe batch producing 2/2 audit-hit rate; C481/C755/C756 next.	1	A
C477	**HT Tail Correlation**	2	HT/A
C478	**REFRAMED 2026-05-19** (batch-sweep). Originally "TEMPORAL COVERAGE SCHEDULING" Tier 2 with 4 sub-claims (back-loaded coverage, front-loaded novelty, U-shaped tail, prefix cycling) interpreted as "pedagogical pacing." Descriptive measurements SURVIVE as Tier 2 (real distributional facts about A's MIDDLE ordering). "Pedagogical scheduling" / "deliberate scheduling" INTERPRETATION DEMOTED to Tier 3 because depended on retracted C476's coverage-optimality framing. See phases/BATCH_SWEEP_2026_01_12/.	2/3	A
...
C755	**DEMOTED Tier 2→3 2026-05-19** (batch-sweep). Originally "A Folio Coverage Homogeneity" Tier 2 (real folios 0th percentile vs synthetic for discrimination, mean 1.064 vs 1.281 = deliberate coverage optimization). Measurement survives. Interpretation "deliberate optimization" inherits from retracted C476 + same "real worse than random reframed as deliberate" pattern that broke C476. See phases/BATCH_SWEEP_2026_01_12/.	3	A
C756	**DEMOTED Tier 2→3 2026-05-19** (batch-sweep). Originally "Coverage Optimization Confirmed" Tier 2 (11× pairwise Jaccard similarity z=1144, 60%% PP coverage in first 10 folios, hub MIDDLEs 100%% PP). The 11× similarity likely has broken-baseline issue (random PP vocab doesn't represent meaningful alternative; same pattern as C476). Hub-MIDDLE structural observation survives. "Coverage optimization confirmed" headline inherits from retracted C476. See phases/BATCH_SWEEP_2026_01_12/.	3	A
...
C1068	**DEMOTED Tier 2→3 2026-05-19** Originally "Cross-Layer Partial Coupling C475×C911 NMI=0.185 perm_p=0.13" (Tier 2). Audit: chi² p=3.4e-292 was against WRONG null (assumes independent marginals; both factors correlate with token frequency). Marginal-preserving permutation null gives p=0.13 (not significant at 0.05). The C475-wholesale-graph concern from C475 demotion was AUDIT_PENDING; spot-check CLEARED it (methodology uses per-MIDDLE attested-degree, not sparsity edges). Companion findings preserved within demotion: C475×C1063 NMI=0.005 INDEPENDENT, C911×C1063 NMI=0.002 perm_p=0.91 INDEPENDENT (clean independence statements). Methodology memory: feedback_chi2_vs_permutation_null_mismatch.md. Third distinct audit failure-mode pattern this session (after C131 invented-threshold and C475 sparsity-denominator).	3	B
...
C1463	zone-hazard routing at line level	2	B, line, zone, frame, hazard, routing, gradient
C1464	k-IMMUNE thermal work onset concentration	2	B, line, zone, k-HEAD, IMMUNE, Q1, thermal
C1465	HIGH frame positional heterogeneity	2	B, line, frame, hazard, HIGH, positional, o-HEAD, a-HEAD
C1466	zone-hazard pattern line-length invariance	2	B, line, zone, hazard, length, invariance
...
C1472	modifier co-occurrence avoidance dominates ordering	2	B, MIDDLE, atom, modifier, co-occurrence, avoidance, ordering, C1393
...
C1475	HEAD atom categorical domain differentiation	2	B, MIDDLE, atom, HEAD, category, domain, THERMAL, FLOW, hazard
C1476	k-HEAD intrinsic hazard immunity	2	B, MIDDLE, atom, HEAD, k, hazard, immunity, intrinsic, compositional
...
C1483	terminal category specificity gradient orthogonal to opacity	2	B, MIDDLE, atom, terminal, category, specificity, opacity, orthogonal, V=0.463, C1440, C1475
C1484	terminal-modifier exclusivity channels	2	B, MIDDLE, atom, terminal, modifier, exclusivity, partition, n-i, y-d, h-cpfs, C1472, C1479
C1485	HEAD x TERM affinity structure	2	B, MIDDLE, atom, HEAD, terminal, affinity, e-y, a-n, a-m, k-avoid, t-avoid, C1475, C1478
C1486	m-terminal line-final closure marker confirmation	2	B, MIDDLE, atom, terminal, m, line-final, TRANSITION, closure, C1434, C1435, C1437
C1487	three-tier terminal functional taxonomy	2	B, MIDDLE, atom, terminal, taxonomy, LOCKED, CHANNELED, DIFFUSE, category, r, m, l, y, n, h, C1440, C1475, C1483, C1484, C1485, C1486
C1488	headless compounds are coherent sixth functional domain	2	B, MIDDLE, headless, compound, domain, coherent, V=0.511, C1397, C1475, C1489
C1489	pseudo-HEAD differentiation by first atom	2	B, MIDDLE, headless, pseudo-HEAD, first-atom, category, V=0.511, d-OPERATION, i-TRANSITION, l-STAGING, C1397, C1475, C1488
C1490	headless terminal profile shifted vs headed	2	B, MIDDLE, headless, terminal, h-enriched, n-enriched, r-depleted, m-depleted, LOCKED-avoidance, C1440, C1487, C1488
...
C1499	atom ontology is manuscript-wide shared substrate	2	GLOBAL, atom, cross-system, HEAD, MOD, TERM, Jaccard-0.895, shared-substrate, C1394, C1395, C1475, C1504
C1500	bridge-dark HEAD differentiation — bridge enriched in e/k/t	2	GLOBAL, atom, bridge, dark-pipeline, HEAD, e-HEAD, k-HEAD, t-HEAD, executable-backbone, C1139, C1264, C1475, C1499
C1501	bridge terminal tier outlier — TERM JSD 5-20x lower than non-bridge	2	GLOBAL, atom, bridge, TERM, terminal, constrained-ecology, JSD, C1487, C1499, C1500
C1502	AZC o-HEAD enrichment 2.70x — arrangement/configuration domain	2	AZC, atom, o-HEAD, arrangement, configuration, 2.70x, C1381, C1388, C1499
...
C1516	AZC zones are HEAD-differentiated — chi²=112.3, V=0.115, refines C1271 atom-uniformity to HEAD-level	2	AZC, zone, atom, HEAD, differentiation, chi-squared, V=0.115, C1271, C1499, C1502
C1517	o-HEAD zone-graded — boundary S=29.3% vs interior R=17.7%, arrangement concentrated at boundaries	2	AZC, zone, atom, o-HEAD, boundary, graded, S-zone, R-zone, arrangement, C1381, C1388, C1502, C1516
C1518	HEAD dominates TERMINAL 5.2x in AZC zone differentiation — classification is HEAD-mediated	2	AZC, zone, atom, HEAD, TERMINAL, dominance, 5.2x, mediation, C1475, C1487, C1516
C1519	Zodiac atom-uniform, A/C 2.0x diverse — structural rigidity maps to atom uniformity	2	AZC, family, atom, Zodiac, A/C, uniformity, diversity, rigidity, C436, C1270, C1516, C1519
...
C1528	Hazard classes map to distinct atom HEAD territories (7/10 pairwise Jaccard = 0)	2	B
C1529	PHASE_ORDERING is headless-y to a-HEAD transition failure (10/11 corpus violations)	2	B
C1530	CONTAINMENT_TIMING is l/r-terminal SEMI_TRANSPARENT class (100% avoidance, 1129 opportunities)	2	B
...
C1546	Universal HEAD atom hazard source immunity (0/16,819 headed tokens are hazard sources; chi2=4411.9)	2	B
C1547	TERMINAL atom determines hazard class type categorically (V=0.306; y→PO, l→CT, bare→RM, h→EO)	2	B
C1548	PREFIX base hazard gradient (e-base 3.37x enriched, k-base 0.30x depleted; V=0.133)	2	B
C1549	q-modifier hazard protection on o-base (~7x via k-HEAD routing; 4.15% vs 27-52%)	2	B
C1550	Sister pair hazard asymmetry (ch/sh 1.80x, ok/ot 0.66x inverted, da/sa 1.54x)	2	B
C1551	Hazard class atom signatures: PO = headless dy, CT = headless l (MIDDLE-intrinsic)	2	B
C1552	5/9 hazard source MIDDLEs are phantom types (0 corpus tokens; defense-in-depth)	2	B
...
C1562	HEAD self-transition rate hierarchy (e/headless ~28.5% >> k 16.7% >> o 13.6% >> t 9.1%)	2	B
C1563	Terminal-to-next-HEAD routing grammar (r→a 2.23x, h→t 1.89x, y→k 1.60x, m→o 1.55x)	2	B
C1564	Suffix carries zero forward HEAD information (JSD=0.0021, effectively zero)	2	B
C1565	Paragraph header modifier divergence 10x greater than HEAD divergence (MOD JSD=0.085 vs HEAD JSD=0.008)	2	B
C1566	Line-position Q3→Q4 step discontinuity (HEAD JSD jumps 26x at closure boundary)	2	B
C1567	Within-domain structural spine validation (16/17 tests pass: k-0% hazard, e→y 0%, o→l STAGING 98.1%, all routing enrichments confirmed)	2	B
C1568	Within-domain cross-folio discriminability (+6.1pp NN, +8.8pp RF gain beyond HEAD-only; top features: o_l_frac, xd_headless_frac, t_flow_purity)	2	B
C1569	Section-level within-domain parameterization (76.8% accuracy, 4.9σ; within-section folio resolution absent; two-level: section=shared profile, folio=domain mix)	2	B
C1570	Deployment features section-level not folio-level discriminators (T2b 18/19 pass, RF COMBINED 90.4% +6.1pp, D3b 0/18 within-section FAIL across 6 sets 6-94 dims)	2	B
C1571	Deployment Ward clustering highest section ARI (DEPLOYMENT 0.615 vs MARGINAL 0.443; deployment grammar stronger section discriminator than marginals)	2	B
C1572	Hierarchical variance partition validates 4-layer nesting (section z=8.0 8/9, folio z=7.1 9/9, paragraph z=2.2 4/9, line selective hazard z=4.09 opacity z=4.53; LSI section=10.28 folio=7.06 paragraph=2.22; residual ~85%)	2	B
C1573	Paragraph emphasis distributions recover within-section folio specificity (EMD S z=6.21 H z=5.06 B z=2.34 all PASS; T2 3/4 sub-tests PASS; T3 B1 variance ratio PASS 3/3; ARI=0.287 gradient confirmed)	2	B
C1574	Headless ecology folio-specific not paragraph-specific (T4-B 13/14 VS_folio>VS_section; T4-C 3.6% FAIL threshold 30%; hl_rate VS_section=0.192 VS_folio=0.258; folio-level infrastructure not paragraph dial)	2	B
C1575	Hierarchical trace executor monotonic improvement (E1=-3.3635 E2=-3.2928 E3=-3.2928 E4=-3.2832; 2.39% improvement; Wilcoxon E4 vs E1 z=-27.85 p=9.5e-171; E4>E1 all 5 sections; all 3 ablations significant)	2	B
C1576	Paragraph cloud aggregate geometric not per-token level (P2 cloud recovery H=0.382 B=0.588 2/3 PASS; E3 domain=E2 domain kNN at any weight degrades; paragraph specificity is shape not per-token prior)	2	B
C1577	Four null models confirm non-trivial hierarchy (N1 token-shuffle z=14.07; N3 line-shuffle z=9.27; N4 form-shuffle z=8.77; N5 terminal-shuffle z=14.18; all >> thresholds)	2	B
...
C1635	Productive disruption efficiency generalizes to 18-folio pilot set spanning 5 sections and 3 apparatus profiles	2	B, virtual apparatus, folio-specific, DYE, DVA, generalization, productive disruption, 18-folio, sections, profiles, C1633, C1634
C1636	Productive disruption efficiency is a broad apparatus property of Currier B with systematic attenuation in A2/section C stratum	2	B, virtual apparatus, folio-specific, DYE, DVA, expansion, productive disruption, 76-folio, sections, profiles, A2 forgivingness, C1633, C1634, C1635
C1637	WCP demoted from apparatus success criterion to legacy continuity diagnostic; endpoint coherence does not discriminate at scale	2	B, virtual apparatus, WCP, demotion, legacy, endpoint, restoring force, C1614, C1636
C1638	Primary apparatus success family is DYE/DVA/YGA — process-quality metrics measuring execution dynamics during closure	2	B, virtual apparatus, DYE, DVA, YGA, success family, process quality, productive disruption, C1632, C1633, C1634, C1636, C1637
C1639	A2_SEALED_RECIRCULATION excess forgivingness mechanism: CLOSE recovery (R1-R5) accounts for 159.5% of excess CCS1; single-channel dominant, rho=0.963 within A2	2	B, virtual apparatus, A2, mechanism, CCS, close recovery, R1-R5, ablation, forgivingness, C1636
C1640	Currier B apparatus family partition: response-only k=2 finds gradient structure (sil=0.361, ARI_2fam=0.385, bootstrap=0.589); 12 forgiving vs 64 productive	2	B, virtual apparatus, clustering, family partition, Ward, silhouette, ARI, C1636, C1639
C1641	Within-A2 weakly structured: section F-ratio=0.055 (not significant), 44% boundary folios (4 A2→A1, 4 A2→A3), only 6/18 pass EPV>=0.80	2	B, virtual apparatus, A2, internal structure, conformity, boundary, C1636, C1639
C1642	A2 grammar-strength forgivingness is strength-dependent: STRONG adv=+0.021 beats null, WEAK adv=-0.014 loses; strength-gated conversion	2	B, virtual apparatus, A2, grammar, forgivingness, CCS, strength-dependent, C1636, C1639
...
C1644	Counterfeit closure threshold: CTS_THRESHOLD_PROFILE_DEPENDENT. A2 requires CTS=0.18 for grammar advantage (vs A1=0.04). The +0.138 CTS shift means A2 folios need substantially more closure specificity. Transition is gradual. At CTS<0.18, A2 grammar loses to null — forgiving-zone closure events fail authenticity	2	B, virtual apparatus, CTS, threshold, counterfeit, profile, C1639, C1643	A2_thresh=0.18. A1_thresh=0.04. Shift=+0.138. Gradual=True.
...
C1652	Regime admission gating: REGIME_ADMISSION_VALIDATED (decisive). AMB_PESSIMISTIC config: A2 delta=+0.0635 (Layer 2 was +0.003). Strong-band DYE preserved=58.7% (<90% target). A2 null wins reduced 7→2. SSI=63.5. Layer 2 (regime admission) strictly dominates Layer 3 (Y-credit only). Architecture robust: 4/5 configs beat AMB_PESSIMISTIC, 5/5 beat CREDIT_ONLY	2	B, apparatus, regime_admission, decisive, C1648, C1649	A2_delta=+0.0635. Strong_pres=58.7%. Null_wins: 7->2. SSI=63.5.
C1653	Strong-band preservation: STRONG_LOSS_EXCESSIVE. Gated strong-band DYE=58.7% of baseline (target >=90%). AUTH_PROTECTIVE and AUTH_THRESHOLD lines have credit<1.0, suppressing some STRONG events. The gate improves A2 delta but damages strong-band signal. Strong-band loss is the primary weakness of regime admission gating	2	B, apparatus, strong_band, preservation, closure, C1652	Strong_pres=58.7%. Target=90%. Loss=41.3%.
...
C1681	Zodiac category seasonal signal: SEASONAL_SIGNAL_CONFIRMED (after zodiac correction). Standard map has 6+ misassigned folios + 2 non-zodiac pages. Corrected confident-only (7 folios): chi2=48.73, V=0.157, perm_p=0.018. Signal real but was masked by incorrect assignments	2	AZC, zodiac, category, season	confident_V=0.157. confident_perm_p=0.018. aries_perm_p=0.033.
...
C1721	Terminal routing is section-parameterized, not folio-specific: ROUTING_SECTION_ONLY. Per-folio TERM→HEAD transition matrices (61 B folios, ≥100 transitions, 42-cell MIDDLE-atom vectors) do NOT discriminate folios within sections. ICC=0.0015 (≈0), token-shuffle null not exceeded (p=0.539). Within-section discrimination fails in all 4 sections (B p=0.91, C p=0.99, H p=1.00, S p=0.85). Section structure real (p=0.001, sil=0.15). C1570 criterion #1 NOT met. Length confound rho=-0.635	2	B, routing, TERM, HEAD, section, folio, C1563, C1570	icc=0.0015. token_shuffle_p=0.539. sec_p=0.001. sil=0.15. length_rho=-0.635.
C1722	Section-level routing correlates with apparatus manifold: ROUTING_APPARATUS_LINKED. TERM→HEAD routing distance (JSD) correlates with apparatus distance across 57 B folios: Mantel r=0.279 (p=0.001). Survives section control: partial Mantel r=0.212 (p=0.001). rPC1 × aPC1 rho=0.603 (q<1e-5). rPC3 × aPC3 rho=0.586. 4/24 routing-accent FDR-significant	2	B, routing, apparatus, manifold, accent, Mantel, C1670, C1367	mantel_r=0.279. partial_r=0.212. rPC1_aPC1=0.603. rPC3_aPC3=0.586. n_sig=4/24.
C1723	Routing space is high-dimensional and bare-terminal dominated: ROUTING_HIGH_DIM. TERM→HEAD routing effective rank 11 (11 PCs for 90% variance), nearly double apparatus manifold (5.88). PC1 (26.3%) loads on bare→e (+0.55), bare→k (+0.33). PC2 (21.5%) loads on y→headless (+0.62). Bare-terminal MIDDLEs dominate cross-folio variance (0.0061 vs 0.0029 for y). m-terminal near-zero (2.5e-5)	2	B, routing, PCA, TERM, bare, dimensionality, C1563	eff_rank=11. PC1=0.263. PC2=0.215. bare_var=0.0061. y_var=0.0029.
C1724	Routing grammar is position-invariant (MARGINAL_PRODUCT). TERM×HEAD×Quintile three-way interaction not significant (G²=144.61, df=120, shuffle p=0.069, Cramér's V=0.084). Routing varies by line position (Q4 JSD=0.0209, 14x Q2) but entirely explained by independent positional marginals P(TERM|Q) × P(HEAD|Q). Global routing grammar (C1563) applies uniformly across all line positions. Specification→work→closure arc produced by compositional change, not position-dependent routing rules	2	B, routing, position, quintile, TERM, HEAD, line, C1563, C1425, C1721	G2=144.61. shuffle_p=0.069. cramers_v=0.084. Q4_jsd=0.0209. n_pairs=20668.
C1725	Closure zone has strongest routing discrimination (mild synergy). Interaction MI=-0.0044 bits (-7.9% of total 0.0552 bits), SYNERGY. Q4 has highest per-quintile MI (0.0714 bits) vs Q1 (0.0496). Reflects sharp compositional focus of closure: fewer active TERM/HEAD types allow grammar to discriminate more sharply. Synergy small (7.9%) — grammar fundamentally position-invariant (C1724)	2	B, routing, MI, synergy, closure, position, C1724, C1566	mi_total=0.0552. mi_interaction=-0.0044. mi_Q4=0.0714. mi_Q1=0.0496.
C1726	Per-rule activation profiles are compositionally driven. l→e declines Q0→Q4 (rho=-0.90, p=0.037), m→o rises (rho=+0.90, p=0.037), n→k declines (rho=-0.90, p=0.037). Strongest: r→a at Q4=3.87x vs 2.23x global. Trends explained by compositional change. No depleted rule becomes enriched at any quintile. Grammar applies uniformly; profiles are readout of positional composition	2	B, routing, activation, rules, position, composition, C1563, C1724, C1671	l_e_rho=-0.90. m_o_rho=+0.90. n_k_rho=-0.90. r_a_Q4=3.87. n_modulated=3/10.
C1727	Line ordering carries non-trivial sequential information. Within-paragraph body-line ordering significantly smoother than shuffled (Stouffer z=-6.048, p<0.001, mean effect=-0.668 across 82 paragraphs, 824 body lines). Only 8.5% individually significant. Universal across all 4 sections. Revises strong form of C670/C1233/C1429: compositional channels independent, structural channels (length, boundary position) carry ordering information	2	B, line, ordering, paragraph, sequential, C670, C1233, C1429	stouffer_z=-6.048. mean_effect=-0.668. n_para=82. n_lines=824. pct_sig=8.5.
C1728	Sequential information NOT primarily Mode A/B persistence. Full mode residualization barely changes signal: z=-5.864 vs z=-6.048, effect -0.648 vs -0.668. Mode ~3% of total. Dominant channel is line length (lag-1 MI=0.178 bits, 9.3% of H), 4x stronger than suffix mode (MI=0.044 bits). HEAD and TERM show no significant lag-1 MI	2	B, line, ordering, mode, length, MI, C1423, C1429	mode_residual_z=-5.864. mode_contribution=3pct. length_MI=0.178. mode_MI=0.044.
...
C1737	Apparatus bundle alignment not confirmed: tested bridge family (48 variants of one framework) does not recover Brunschwig method-bundle→Voynich secondary apparatus profile alignment. 0/4 tests, robustly negative (0% significant, 88% negative Mantel r). Failure of tested bridge family, not disconfirmation of apparatus structure itself (validated by C1248, C1380, C1625-C1629, C1640, C1668, C1722). P4 design concern: distill_references>=2 may not correspond to open-cycle intervention	2	B, apparatus, Brunschwig, REGIME, secondary profiles, C1248, C1735, C1736	P1_mantel_r=-0.279. P2_match=0.25. P3_concordant=1/3. P4_cosine=-0.606. variants=48. pct_sig=0%. hash=5dded97c.
C1738	SEALED_VESSEL universal secondary dominance: all 5 viable cells show SEALED_VESSEL as dominant secondary profile (0.328-0.609). Compressed dominant-axis contrast expected under tested bridge. Does NOT show secondary space fails to differentiate by apparatus identity — cells may differ in proportions, geometry, distributional shape while sharing SV top-1. SV vocabulary may encode general containment/waiting operations	2	B, apparatus, SEALED_VESSEL, secondary profiles, C1248, C1249	SV_range=0.328-0.609. n_cells=5. non_ambig=4/5. margin_range=0.013-0.324.
C1739	Closure-response alignment not confirmed: 0/4 tests. Bridge assumes monotone containment→preventive safety, but closure manifold is profile/threshold-dependent (C1639-C1648, C1732-C1733). H:R2 reversal (lowest ey 0.0604, highest ii 0.1136) = authenticity-sensitive containment loading onto transformative safety. Sealedness ≠ preventive safety. Annotation stable (H1 rho=0.744, H2 rho=0.842)	2	B, Stars, apparatus, Brunschwig, REGIME, closure, safety, C1735, C1737, C1639, C1642	P1_mantel_r=-0.385. P1_p=0.866. P2=3/4. P2_p=0.319. P3=0/3. P4=0/3. hash=eb6824e8.
C1740	Stars safety substitution within-section concordance: ey_rate R1=0.1823 > R3=0.1039 (p=0.0003, replicates C1735). ii_rate R1=0.0605 < R3=0.0918 (p=0.0259, NEW). DYE_advantage REVERSED — DYE is intervention-productivity metric (C1633-C1634), orthogonal to preventive/transformative safety axis. First direct confirmation safety substitution (C1732/C1733) aligns with Brunschwig within-section	2	B, Stars, safety, e-to-y, ii, REGIME, Brunschwig, C1732, C1733, C1735, C1633	ey_R1=0.1823. ey_R3=0.1039. ey_p=0.0003. ii_R1=0.0605. ii_R3=0.0918. ii_p=0.0259.
C1741	A2 compound apparatus regime categorical safety shift: A2 is not "more forgiving" on a scalar — it is a compound regime (high null recovery C1639, higher authenticity threshold C1644, morphology-selective counterfeiting C1645, weak events lose to null C1642). S3 A2 dummy coeff=-0.124, t=-5.31, p=1e-6, R²=0.579. A2 sb=-0.022 vs non-A2=0.096. Continuous forgivingness fails (P1 rho=-0.047 p=0.686; P2 F=0.457 p=0.506). Stars anchor: R1=0.122>R3=0.012, p=0.002. A2 is a profile regime, not a one-dimensional forgivingness coordinate	2	B, apparatus, safety, A2, profile, REGIME, Stars, Brunschwig, C1739, C1740, C1639, C1644, C1645, C1642, C1732, C1733	S3_coeff=-0.124. S3_t=-5.31. S3_p=1e-6. S3_R2=0.579. S2_p=0.002. P1_rho=-0.047. P2_F=0.457.
C1742	Closure authenticity modulates safety strategy: strong_close_fraction positively predicts safety_balance after section control. If closures genuinely strong, preventive stabilization viable; if weak/counterfeitable, transformative rescue. Section-controlled partial Spearman rho=0.304, p=0.008 (n=76). Raw rho=0.010 p=0.932 — within-section only. DYE orthogonal (Stars p=0.204, all p=0.702). Connects C1642-C1647 to C1732-C1733. Independent of A2 profile effect	2	B, closure, safety, authenticity, strong_close_fraction, C1642, C1644, C1647, C1732, C1733, C1741	P4_rho=0.304. P4_p=0.008. raw_rho=0.010. S1a_p=0.204. S1b_p=0.702.
C1743	Removing A2 restores Herbal thermal-intensity ordering: within Herbal A3 (excluding A2), R4>R3 on safety_balance (p=0.021). Phase 600 Herbal reversal (C1739) was specifically A2 contamination, not general Herbal behavior. Does NOT establish "higher REGIME = more preventive safety" as general law (C1730 non-monotone; C494 R4=precision axis). Local ordering recovery specific to A3 Herbal context	2	B, Herbal, A2, A3, REGIME, safety, surgery, C1741, C1739, C494, C1730	P3_R4_sb=0.101. P3_R3_sb=0.032. P3_U=38. P3_p=0.021.
C1744	Monitor->action chain stabilization-dominant asymmetry: pseudo-Lull E8 judgment cue consequences show stabilization ratio 2.39 (67/28 stabilize/escalate), abort 1.0%. Matches Voynich kernel directionality (k->e 4.02x, h->e 6.09x observation->stabilize; e->h 0.004x blocked). Brunschwig has zero monitoring passages (C1056). First historical alignment beyond thermal intensity.	2	B, kernel, monitoring, pseudo-Lull, C1056, BCSC	stabilization_ratio=2.39. abort_fraction=0.010.
C1745	Recovery doctrine maps to safety-style split: both pseudo-Lull and Voynich show preventive-dominant safety. PL recoverable/irrecoverable=6.24:1 (156/25). V ey/ii=1.92:1 (ey=0.138, ii=0.072). Both >1.0 same direction. PL in-process correction parallels V e->y/ii substitution (C1732-C1733).	2	B, safety, recovery, pseudo-Lull, C1732, C1733	PL_ratio=6.24. V_ratio=1.92. mean_ey=0.138. mean_ii=0.072.
...
C1799	Vocabulary completely absorbed by PREFIX composition: B-folio MIDDLE Jaccard→manifold collapses from r=0.257 to r=-0.028 after PREFIX control. Vocab|PREFIX+shape r=-0.041. Vocabulary carries zero independent apparatus information.	2	B, vocabulary, PREFIX, manifold, mediation, Mantel, C1709, C1801	raw_r=0.257. partial_pfx_r=-0.028. partial_pfx_shape_r=-0.041. n=73.
C1800	Paragraph shape carries independent deployment signal: partial r=0.163 (z=8.43) surviving PREFIX+vocab control. Half raw signal (0.317→0.163) persists. Deployment architecture encodes apparatus identity independently of vocabulary.	2	B, paragraph, shape, deployment, manifold, PREFIX, C1796, C1799	raw_r=0.317. partial_pfx_vocab_r=0.163. z=8.43. retention=51.4pct.
C1801	PREFIX composition is strongest single apparatus manifold predictor: Mantel r=0.476 (z=7.51), partial|section r=0.437. Stronger than vocab (0.257), shape (0.317), or combined (0.358).	2	B, PREFIX, manifold, Mantel, prediction, C1405, C1709, C1796	raw_r=0.476. partial_section_r=0.437. z=7.51. n=73.
C1802	Combined vocab+shape improvement real but modest: alpha=0.5 r=0.358, improvement +0.040 (below +0.05 threshold). T4-null p=0.002 confirms improvement real. Best alpha=0.4 r=0.361.	2	B, vocabulary, shape, combined, manifold, complementary	combined_r=0.358. improvement=+0.040. T4null_frac=0.002. best_alpha=0.4.
...
C1959	RETRACTED v6.37 — monotone-by-construction circularity in phase assignment. Awaiting independent methodology.	RETRACTED	B, paragraph, ordering, recipe-correspondence	retracted_phase_667.
C1960	RETRACTED v6.37 — failed own pre-reg criteria (1/5 vs required 3/5); paragraph-size confound. Awaiting size-controlled redesign.	RETRACTED	B, paragraph, heat-mode, recipe-correspondence	retracted_phase_667.
C1961	Fire-side / vessel-side paragraph-level PREFIX partition. Fire-side {qo, ch, sh} anti-correlates with vessel-side {ok, ot, ol, or}: cross-block r̄=−0.232, within r̄=+0.080. Folio diff=+0.295 (n=82, p=0.058 borderline). PARAGRAPH diff=+0.131 (n=466, p=0.024) — survives at PREFIX-load-bearing scale per C1811-C1812. Sections: 3/4 SURVIVES (B p=0.015, H p=0.027, S p=0.018). Regimes: 3/4 directional, REGIME_2 (low-link iteration) FAILS directionally — documented scope exception (LINK-as-separator hypothesis Tier 3 candidate). Bridge: qo↔ol=+0.29 (only positive cross-block cell). ch paragraph-LATE 1.18×, sh paragraph-EARLY 1.13× (refines C929 with temporal positioning). Compatible with token-scope C1217/C1242/C1306 at orthogonal scale.	2	B, PREFIX, paragraph, partition, fire-vessel, C1811, C1812, C1217, C1242, C1306	folio_diff=+0.295. par_diff=+0.131. par_p=0.024. n_par=466. sec_pass=3/4. reg_pass=3/4. qo_ok=−0.42. ch_ol=−0.45. qo_ol=+0.29.
C1962	4-axis o-prefix runtime channel taxonomy. ol = vessel-content state monitoring (which vessel holds what, batch identity, vessel role). ot = material transfer/addition/iteration cycles (broadens C1958 drip-rate; drip-rate is f83r-specific manifestation). ok = thermal regime/fire-degree on contents. or = outcome/completion state (per C539 LATE class; weakest gloss, no matched recipes; or-dominant only on herbal-B + small recipes-section folios). All four positionally uniform within paragraphs (early/base 0.75–1.13×) — falsifies ol-as-setup-phase alternative. Within-sample: 16/16 top-1, 7/16 top-2 strict (43.8% vs 17% random). Refines C1388 (ol gloss sharpened, preserves C1174 deflation) and C1958 (ot generalized). Out-of-sample validation pending. **Refined Phase 649 (C1964): token-scoped at prefix level, NOT line-scoped.**	3	B, PREFIX, o-prefix, taxonomy, channels, recipe-correspondence, C1388, C1958, C1316, C539, C1964	top1=16/16. top2=7/16. n=16. ol_top=8. ot_top=6. ok_top=2. or_top=0. position_uniform=4/4.
C1963	qo as paragraph operational opener. When qo and any o-prefix appear in same paragraph, qo precedes the o-prefix in 77.9% of cases (mean across 4 pairs, range 72.9-84.7%). qo→ok 72.9% (n=391), qo→ot 73.6% (n=394), qo→ol 80.5% (n=343), qo→or 84.7% (n=209). Sister pairs ok↔ot 48.5%, ol↔ot 45.3% — symmetric ~50/50, confirms C1304. ch/sh asymmetric: sh→ch 61.2% n=399 (passive monitor before active test, refines C929 with paragraph-scale temporal positioning). qo precedes da in 80% (heat-setup before material-introduction). Mechanism: grammatical precedence per C1300/C1316/C1394, NOT pair-specific. Thermal-mass alternative tested across 3 framings (rho≈+0.20, never p<0.05, Section S reversal); not registered.	2	B, PREFIX, paragraph, ordering, qo, generic-precedence, C1300, C1316, C1394, C929, C1304	mean=77.9%. spread=11.8pp. qo_ok=72.9% n=391. qo_ot=73.6% n=394. qo_ol=80.5% n=343. qo_or=84.7% n=209. sh_ch=61.2%. qo_da=80%.
C1964	PERMANENTLY RETRACTED v6.37 — baseline artifact. 85.3% within-line transition rate is BELOW all-token same-line rate (91.2%) and prefixed-token baseline (85.6%). z=-0.96 NS. The statistic presented as evidence was actually below what random gives you.	RETRACTED	B, PREFIX, line, interleaving	retracted_phase_667.
C1965	f75r cycle-counting + per-cycle annotation idiom. Recipe III.19 (×4 then ×9 vegades reflux) encodes both phases as line-localized closed-cycle clusters. Closed cycle = qok+...+dy (excludes transitional sub-states like qokey). ×4 phase: 4 cycles on L13 (corpus rarity ~7). ×9 phase: 10 cycles in L36-L38 3-line window (1 initial + 9 redistillations) — CORPUS-SINGULAR (only such window in all of Currier B). Cycles 4-5 (qokchdy, qokechdy) carry ch MOD atoms at the recipe's phase boundary, marking active-test cycles per C929 generalized to per-cycle annotation. Idiom does NOT generalize to small-count recipes (f82v ×4: rarity 30+; f112r ×3: no clean match) — small counts indistinguishable from corpus noise at line-window resolution. C1394 refinement: MOD class includes continuous-extensible (e per F-B-007) AND discrete-event (ch per C929) subtypes; should not be conflated.	3	B, f75r, qok-cycles, recipe-correspondence, atom-annotation, C929, C1394, C1735, C1300	x4_window=L13_4cycles. x9_window=L36-L38_10cycles. corpus_rarity_x9=1 (singular). ch_at_cycles=4,5. phase_boundary_aligned=yes. f82v_x4_rarity=30+. f112r_x3=no_match.
C1966	HT density per Currier B folio correlates with distinct compound MIDDLE count. RETESTED Phase 667: original rho=+0.602 had type-token confound (HT count vs types: rho=+0.960). Partial Spearman controlling for HT token count: partial_rho=+0.189, p=0.045. Signal survives but ~70% was confound. Direction and significance preserved after control. Refines C935 from "HT carries compound specification" to "HT rate tracks compound diversity independently of total HT count, but weakly."	2	B, HT, compound, specification, per-folio, density, C935, C740, HTSC	partial_rho=+0.189. partial_p=0.045. original_rho=+0.602. confound_rho=+0.960. n=82. retested_phase_667.
C1967	e_depth paragraph-channel gradient. RETESTED Phase 667: original had no statistical test and compositional confound (qo-prefix tokens inherently carry higher e_depth). Non-prefix token gradient: qo=0.471 > ch=0.446 > sh=0.357, permutation p=0.024 (gradient qo-sh = +0.114). Gradient survives after removing prefix-token composition. All-token gradient also significant (p=0.002) but compositional control is the binding test. Cross-validates F-B-007 at paragraph aggregation with proper methodology.	2	B, paragraph, e_depth, channel-class, thermal-intensity, F-B-007, C1300, C929, C1961, C1225	nonpfx_qo=0.471. nonpfx_ch=0.446. nonpfx_sh=0.357. gradient_nonpfx=+0.114. p_nonpfx=0.024. retested_phase_667.
C1968	ch-class paragraph-header compound-specification concentration. Block-pure ch-dominant paragraphs concentrate compound MIDDLE tokens (HT) at paragraph header. Shared-token-controlled gap +0.066 (p=0.007, n=82). Other channel classes do NOT show genuine concentration after C1789 token-pool control: qo collapses (+0.012, p=0.59); sh REVERSES (-0.041). Refines C929 (ch=active test) with operational claim: active-testing operations require explicit compound-specification at paragraph header before test execution. Pairs with C1967 supplement (sh-class largest e_depth body-concentration) to establish channel-class-distinctive header-body specialization patterns: ch concentrates compound-spec at header; sh concentrates thermal-commitment at body; qo is consistent throughout. Header-body division is NOT universal — channel-class-specific. Methodology lesson: token-pool control was decisive; without it, would have registered broad universal claim. With it, narrowed to ch-only with stronger interpretation.	2	B, paragraph, header-body, ch, compound-specification, channel-class, C929, C935, C1966, C1789, C1967	ch_shared_gap=+0.066. ch_shared_p=0.007. ch_n=82. qo_collapsed=+0.012_NS. sh_reversed=-0.041. token_pool_overlap=38pct.
C1969	Window-density qok-class specificity for the f75r x9 anchor. >=9 qok-class tokens within any 2-consecutive-line window appears on 3/82 = 3.7% of Currier B folios (f75r L37-L38, f86v3 L1-L2, f108r L48-L49). Of these three high-density folios, only f75r matches a Catalan chapter (III.19.0) carrying explicit "x9 vegades" REPETITION marker. Matched-pair specificity test: 4/4 numerical anchors land on matched folios, p=0.0208 under 10,000-permutation null with within-recipe pairing preserved. Corpus ceiling at 9 (no folio reaches >=10). f86v3 matched II.10.0 (conjunction of liquefactions) and f108r matched III.16.0 (ferment multiplication) reach the threshold WITHOUT explicit numerical markers, separating density-as-cycle-count (falsified) from density-as-procedure-type-signature (consistent with). Confirms Phase 636 f75r x9 anchor under third independent methodology after Phase 657 (prefix-class contiguous, NULL) and Phase 658 (lexeme contiguous, INCONCLUSIVE). Methodology lesson: when re-testing a documented finding under cleaner methodology, the test signal-shape must match what the original signal actually was — not a sanitized abstraction. Phases 657/658 tested cleaner-LOOKING propositions (contiguous clusters) but tested the wrong propositions; Phase 659 tested what Phase 636 actually documented (window-density) and produced signal.	2	B, cross-folio, qok, window-density, recipe-correspondence, x9-anchor, C1925, C1928, C1959, C1965	rare_density=3of82=3.7pct. observed=4of4. null_mean=2.16. p=0.0208. corpus_max=9. f75r_L37_L38=9. f86v3_L1_L2=9. f108r_L48_L49=9.
C1970	PERMANENTLY RETRACTED v6.37 — metric artifact. Original ke/max(1,ek) has inconsistent units (ratio when ek>0, count when ek=0). With ke/(ke+ek) proportion: d=+0.256, p=0.24 (INCONCLUSIVE). Original d=+1.04 was inflated by artificial outliers from the inconsistent metric.	RETRACTED	B, paragraph, ke/ek, balneum-mariae	retracted_phase_667.
C1971	Cold read coherence: 15/15 matched folios produce coherent or plausible paragraph-level readings against Pseudo-Lull Testamentum recipes (12 coherent, 3 plausible, 0 incoherent). All 3 CONFIRMED-tier matches coherent; all 4 strong-supported coherent; 5/8 supported coherent, 3 plausible (specification/philosophical chapters). Atom glosses (C1394/C1195) produce control-grammar readings that align with recipe operations without post-hoc adjustment.	2	B, recipe-correspondence, cold-read, paragraph, atom	coherent=12. plausible=3. incoherent=0. confirmed_coherent=3of3. strong_coherent=4of4. supported_coherent=5of8.
C1972	e-depth quantitative thermal encoding across 15 matched folios. e-depth tracks physical chemistry thermal requirements at paragraph resolution. Range 0.09 (final coagulation fire, f107r P18) to 1.50 (cold collection, f79r P9 / f107r P7). Balneum mariae paragraphs cluster 0.55-0.67; distillation/condensation 0.92-1.20; strongest fire 0.09-0.34. Cross-validates C1967 non-prefix gradient against external recipe content.	2	B, atom, e-depth, thermal, recipe-correspondence, C1967, C1735, C1225	min=0.09. max=1.50. balneum_range=0.55-0.67. distillation_range=0.92-1.20. fire_range=0.09-0.34. n_folios=15.
C1973	Observation MIDDLE density tracks recipe monitoring requirement across 15 matched folios. ckh/cth/ecth/ckhh/cthh density correlates with recipe type: fusibility test (f116r ~23) and calcination (f80r 23) produce dense observation; patience/coagulation (f82r 3, f107r 2) produce near-zero. Active intervention paragraphs carry observation MIDDLEs; autonomous processing paragraphs lose them (fade-out confirmed on 5 folios). ecth concentrates on calcination/transfer recipes (f80r: 11 tokens).	2	B, MIDDLE, observation, recipe-correspondence, paragraph, C929	f116r_obs=~23. f80r_obs=23. f82r_obs=3. f107r_obs=2. f80r_ecth=11. fade_out=5_folios.
C1974	Paragraph count tracks recipe step complexity across 15 matched folios. Range 2 (two-phase potable gold, f81v) to 18 (highly iterative coagulation, f107r). Simple single-operation → 2-4 paragraphs; multi-step distillation/sublimation → 8-12; highly iterative → 14-18.	2	B, paragraph, recipe-correspondence, C1399, C1400	min_para=2. max_para=18. n_folios=15.
C1975	dar distribution tracks recipe material-addition pattern across 15 matched folios. Five patterns: front-loaded (f103r 81% in P1-P5), back-loaded (f75r P9 46%), zero-after-midpoint (f112r P6-P14 zero), extreme-density (f77v P2 17.2%, f81v P1 16.5%), uniform-low (f107r 2.0%).	2	B, PREFIX, dar, recipe-correspondence, paragraph	f103r_front=81%. f75r_back=46%. f77v_P2=17.2%. f107r_rate=2.0%.
C1976	Polyalphabetic cipher hypothesis REJECTED. Soft atoms (d,o,c,p,s,f,r) tested for meaning shift across prefix classes via bigram cosine similarity. Core atoms stable: d=0.994, o=0.924, r=0.939. Lower c=0.640, p=0.660, f=0.609 explained by positional artifact (PSEUDO_HEAD under ch vs MOD under qo), not semantic shift. One cipher system; stable atom semantics.	1	B, atom, cipher, falsification, C1394	d_cos=0.994. o_cos=0.924. r_cos=0.939. c_cos=0.640. p_cos=0.660. f_cos=0.609.
C1977	Recto/verso thermal pairing: same-leaf folios have correlated mean e-depth (Pearson r=0.665, p=0.0001). Tested 35 r/v pairs; mean |recto-verso| diff 0.124 vs 0.213 random. Extends C1936 from semantic to structural — ALL r/v pairs pair, not only matched recipe pairs.	2	B, recto-verso, leaf, e-depth, thermal, C1936, C1325	n_pairs=35. r=0.665. p=0.0001. mean_diff=0.124. random_diff=0.213.
C1978	Recto/verso operational profile pairing: same-leaf folios share full PREFIX distribution profiles (cosine 0.931, section-stratified p<0.0001). Survives 4 controls: section-stratified permutation, adjacent-folio comparison (R/V +0.038 advantage), without-qo channel, broader 83-folio baseline. All 9 prefix channels positively correlate (qo r=0.811, lk r=0.649, sa r=0.544, sh r=0.531, ok r=0.486, ot r=0.486, da r=0.437, ch r=0.399, ol r=0.384).	2	B, recto-verso, leaf, PREFIX, profile, C1936, C361	n_pairs=35. cos=0.931. p<0.0001. qo_r=0.811. lk_r=0.649.
C1979	PREFIX-conditional terminal-atom positional gradient (da family). Same-prefix tokens sort to systematically different line positions by terminal atom: -ir/-iin/-in early (means 0.345-0.421), -l late (dal 0.618), -m strict line-final (dam 0.861). Within-line and folio-level permutation tests both p<0.01 for 5 of 6 tokens. Length, dam-adjacency, paragraph-initial confounds excluded. Cross-references C1486 (universal -m line-final).	2	B, PREFIX, terminal, atom, da, position, gradient, C1486, C1394, C1925	daiin n=310 mean=0.413 p<0.0001. dair n=49 mean=0.345 p<0.001. dal n=130 mean=0.618 p<0.0001. dam n=42 mean=0.861 p<0.0001. dar n=188 mean=0.507 n.s.
C1980	dar bimodal line-position distribution (observation). Despite mean=0.507, dar concentrates at line edges (deciles 13.3,6.4,11.7,8.0,6.9,8.5,8.0,11.7,12.2,13.3) avoiding middle. Bimodality coefficient 0.581 (threshold 0.555). Mean-position permutation cannot detect this — distributional analysis required. Mechanism candidate "clause-edge marker" REJECTED by C1981; observation reframed as instance of a-HEAD r-TERM class property (C1982).	3	B, PREFIX, dar, distribution, bimodal, observation, C1925, C1979, C1981, C1982	n=188. mean=0.507. var/uniform=1.23. bimod_coef=0.581. skew=-0.106.
C1981	Clause-structure hypothesis for dar bimodality REJECTED. Pre-registered: J1 length-conditional peak tracking (does dar's bimodal peaks scale with line length?) — peaks position-absolute (decile 0 + line-end across all length bins), do NOT shift with length. J2 conditional MI(dar_pos; nearest_headless_offset | length_bin) = 0.0000 bits, p=1.0000 (actual lower than random null mean 0.7139). dar bimodality = line-edge concentration only, not interior clause-boundary marking. F3 paragraph-zone residualization survived (BC 0.564 -> 0.557), so paragraph-position aggregation also ruled out. Supports C964 (boundary-constrained free-interior grammar).	1	B, dar, bimodality, falsification, clause-structure, C1980, C964	J1_8-12tok_peaks=0.05/0.85. J1_13+_peaks=0.05/0.95. J2_MI=0.0000. J2_null_mean=0.7139. F3_BC_drop=0.007.
C1982	a-HEAD r-TERM tokens share bimodal line-position class profile. 4 of 5 a-HEAD r-TERM tokens with n>=30 are bimodal: ar (BC=0.600, n=198), dar (BC=0.581, n=188), otar (BC=0.576, n=92), air (BC=0.638, n=34). Outlier: okar (BC=0.490, n=85). dar bimodality (C1980) generalizes to atom-frame class. Mechanism unknown (clause structure rejected per C1981); candidates include discourse-level scope markers, RI/PP/INFRA edge partitioning, or atom-frame-specific deployment patterns.	3	B, atom, frame, a-HEAD, r-TERM, bimodality, observation, C1980, C1394	ar n=198 BC=0.600. dar n=188 BC=0.581. otar n=92 BC=0.576. air n=34 BC=0.638. okar n=85 BC=0.490. 4/5 bimodal at threshold 0.555.
C1983	sh-prefix and ch-prefix differ in within-line position on fixed e->y frame (Currier B body-only, articulators excluded). sh-e->y start-loaded (mean=0.433, n=783); ch-e->y flat (mean=0.521, n=1133). Within-line permutation diff=-0.088, p=0.0000. Survives paragraph-line>=3 (diff=-0.101, p=0.0001), section stratification (sh start-loaded in H/B/S, ch flat in all 3), articulator exclusion (C1417), LATE-class exclusion (C539). PREFIX carries positional info beyond frame composition (HEAD/TERM identity), articulator presence, LATE-class membership, and line-zone effects (C1426). Direct extension of C1001 (PREFIX dual encoding); aligns with C929 semantic distinction (sh=passive monitor, ch=active test).	2	B, PREFIX, position, sh, ch, e->y, frame, C1001, C929, C1426, C1457, C1808, C1417, C539	sh n=783 mean=0.433 BC=0.564. ch n=1133 mean=0.521 BC=0.556. perm_p_body=0.0000. perm_p_para3=0.0001. sh_H=0.379, sh_B=0.450, sh_S=0.411.
C1984	Folio-level PREFIX-content alignment fails. Across 11 Phase-668-validated Voynich-Pseudo-Lull folio-recipe pairs, PREFIX rates (qo, ch, sh, ok, ot, ol, lk, lch) tested against keyword-density categories (heat, monitor, transfer, iter, vessel, complete) show no surviving correlations after multiple-comparison correction. 2/48 cells passed uncorrected p<0.05 (ok-monitor rho=+0.645 p=0.042; ot-complete rho=+0.618 p=0.049) — within chance frequency (~2.4 expected). PREFIX gloss system survives at category level (intra-folio operational classification per C1300, C929, C1962) but FAILS at folio-density-prediction level (cross-folio rate vs recipe content density). External anchor test proposed by crazy-expert; clean NULL where internal permutation would have produced significance from power.	3	B, PREFIX, recipe-correspondence, alignment, scale, NULL, C1300, C929, C1962, C1971, C1983	n_folios=11. n_cells=48. uncorrected_significant=2. corrected_threshold=0.001. survivors=0. qo_heat_rho=-0.118 p=0.73.
C1985	Phase 642 26-folio pharmaceutical cluster maps to Herbal section (19/26 H, 4 C, 2 S, 1 T) with zero overlap with Phase 668 matched-alchemical folios (7 B + 4 S, no H). Naïve cluster-vs-matched comparison shows multiple |d|>2.0 effects on e-channel suppression and morphological palette (HEAD-e d=-2.68, TERM-r d=+2.59, e-depth=0 d=+2.75, qo d=-2.06, kernel-e d=-2.46) but these recapitulate known section-mediated effects (C939, C1404, C1893, C1808) and cannot be distinguished from them given zero matched folios in Herbal section. Limits cluster-property claims pending matched-H folios or within-folio tests. Methodological scope-limit constraint, NOT falsification of Phase 642's PC1 cluster identification.	3	B, cluster, herbal, section, scope-limit, confound, NULL, C939, C1404, C1893, C1808, Phase642	cluster=26, matched=11. cluster_section: 19H 4C 2S 1T. matched_section: 7B 4S 0H. naive_HEAD_e_d=-2.68. naive_qo_d=-2.06. naive_e_depth=0_d=+2.75.
C1986	Manuscript-wide procedural arc via internal e-depth gradient REJECTED. Pre-registered Phase 675 test (paragraph layout-position vs length-residualized e-depth-mean across 46 Currier B folios with >=4 paragraphs) failed at baseline: |mean_rho|=0.367 < 0.4 pre-reg threshold. Apparent section-conditional pattern (H mean -0.48, cluster -0.29) COLLAPSED under paragraph-1 ablation falsifier (H: -0.48 -> -0.10; Cluster: -0.29 -> -0.04). C1287 (paragraph-header MARKING-enrichment) is the dominant confound — paragraph-1 specification-vocabulary inflated e-depth, creating apparent monotonic gradient. Only Biological-section weak gradient (-0.18 after P1, n=13) survives. C1399 (paragraph independence universal) survives this test. Crazy-expert predicted P1 trap correctly.	1	B, paragraph, layout, e-depth, gradient, falsification, NULL, C1287, C1399, C939, C1985	n_folios=46. baseline_mean_rho=-0.174. baseline_abs=0.367. H_baseline=-0.48 -> p1_drop=-0.10. cluster_baseline=-0.29 -> p1_drop=-0.04. B_p1_drop=-0.18. S_p1_drop=-0.02.
C1987	Cross-cipher token operational profiles equivalent under section-matched comparison. SISMEL Testamentum source uses 4 cipher systems (Part II A-H B=mercury; Part III B-G B=water; Tavola 2 mirror; Practica). Phase 676 test: 30 frequent Voynich tokens (n>=5) appearing in both Part-II-matched folios (f76r, f84r) and Part-III B-section-matched folios (f75r, f79r, f82r, f76v, f81v). Per-token operational profile (position, e-depth, terminal/head rates) mean distance Part II vs Part III B-sec = 0.086, smaller than within-Part III random-split null (0.139). REGIME-mismatched control (Part II vs Part III S-sec) = 0.124, slightly higher, consistent with REGIME secondary factor. Foundation of matching catalog (C1971) survives controlled test for first time. Scope: n=2 Part-II folios; cannot generalize to all cipher systems.	3	B, cipher, token, invariance, foundation, recipe-correspondence, C171, C1394, C1976, C1971	n_common_tokens=30. p2_vs_p3b_dist=0.086. within_p3b_null=0.139. p2_vs_p3s_dist=0.124. mean_edepth_diff=0.000. mean_position_diff=0.086. n_p2_folios=2. n_p3b_folios=5. n_p3s_folios=4.
C1988	f103r encodes rare-cardinality cluster matching source iteration count. f103r matched to III.16 (ferment multiplication "all four or eight chambers"). Pre-registered N=8 from source. Observed exactly 8 qok-class tokens (qokeedy x3, qokeey x3, qokeodair, qokshy) at L36-L37 (~67% through 54-line folio), in rare 15% folio-relative baseline band. Position aligns with recipe's late chamber-multiplication passage. Joint with f75r ×9 template (C1965): 2/2 rare-N predictions hit exactly, joint chance p=0.006. Adds one novel anchor to C1965/C1969 evidence base. Limitations: single novel case (f75r is template); f82r ×9 miss explainable but post-hoc; N=3 cases corpus-trivial (83% baseline) and uninformative; qualitative cluster-reading inadmissible for tier promotion. Promotion to Tier 2 requires third pre-registered rare-N anchor on novel folio.	3	B, cardinality, iteration, recipe-correspondence, qok-class, f103r, C1965, C1969, C1925, C1971	f75r_N=9_observed=9_baseline=4pct. f103r_N=8_observed=8_baseline=15pct. f82r_N=9_observed=7. N3_baseline=83pct. joint_p_rare_N=0.006.
C1989	Rosette path/node structural differentiation. Within the f85-86 rosettes foldout (data/rosettes_annotated.json), path tokens between rosettes (n=25, 8 paths in octagonal cycle) differ structurally from rosette node tokens (n=409, 9 rosettes). Paths show 9.4x enrichment in da-prefix (16% vs 1.7%) and 4.3x depletion in ok-prefix (4% vs 17.1%). Survives same-folio baseline control (f85+f86 body has 6% da-prefix, intermediate). Recipe-class operational map interpretation FALSIFIED by whitelist-sensitivity test (45/100 random non-matched 11-folio pools reproduce same spatial coherence). Path/node distinction is intentional structural property of the foldout, not arithmetic artifact. Mechanism not adjudicated; consistent with workshop-apparatus-diagram interpretation (SPECULATIVE/rosettes_workshop_diagram.md).	3	Rosettes, foldout, path-node, da-prefix, ok-prefix, structural, C1124, C1126, C1128	path_da=16pct. node_da=1.7pct. path_ok=4pct. node_ok=17.1pct. folio_baseline_da=6pct. F3_random_pool_p=0.45.
...
C1997	Per-folio token-transition order constraint is widespread but heterogeneous. 115 folios with n>=100 tokens, mean z_mu=-1.266 (one-sample t=-8.66, df=114, one-sided p<<1e-13). 76% folios negative, 29% below -2, 0/115 above +2. Length-confound: regression z_mu~log(n_tokens) slope=-1.14 (t=-4.95, p<0.0001, R^2=0.18); effect partly size-amplified but genuine even at small folios (n=100 projects to z_mu~-0.40, n=613 projects to z_mu~-2.47). Cross-section heterogeneity per C1999 dominates within sections.	2	GLOBAL, per-folio, transition-graph, z-score, order-constraint, length-confound-controlled, C1999	n_folios=115. mean_zmu=-1.266. t=-8.66. df=114. frac_negative=76pct. frac_below_neg2=29pct. frac_above_pos2=0pct. length_slope=-1.14. length_R2=0.18. zmu_at_n100=-0.40.
C1998	INFRA-RI H_succ comparison in Currier B is confounded by frequency-induced ceiling on RI; pre-registered direction not testable under naive comparison. Naive comparison (NOT FREQUENCY-MATCHED): E[H_succ|INFRA]=2.89 bits (n=54 types in B), E[H_succ|RI]=2.29 bits (n=6 types), gap +0.60 bits in opposite direction from pre-reg. Construct-validity issue: H_succ mechanically bounded by log2(k) where k=observed successor count. RI tokens in B are predominantly rare (n=3-11; consistent with C498.b/C498.d/C831 RI singleton-dominance), capping their H_succ regardless of any structural property. Pre-reg presumed frequency was matched; it wasn't. The +0.60 bit gap is the construct-validity confound, not a structural finding about INFRA vs RI semantic role. Pre-registered formulaic-glue mechanism NOT TESTED. Forecloses retest under same methodology. REVISED 2026-05-07 (hygiene pass) — original framing "directional negative on INFRA vs RI" was inaccurate; the test was confounded from the start.	2	B, construct-validity, frequency-confound, transition-graph, H_succ, INFRA, RI, NOT_TESTED, C498, C831, hygiene-revised	INFRA_n_types=54. RI_n_types=6. INFRA_mean_H=2.89. RI_mean_H=2.29. naive_gap=+0.60_bits. confound_status=NOT_TESTED. revised_2026-05-07.
C1999	Section-level transition-graph order-constraint magnitude varies systematically. Per-folio z_mu differs across 7 sections: Kruskal-Wallis H=27.7, df=6, p=0.0001. Section ordering: S(-2.04) > C(-1.96) > B(-1.95) > Z(-1.20) > T(-1.12) > P(-0.93) > A(-0.74) > H(-0.30). Pre-registered post-hoc B vs H: MWU two-sided p=0.0003, mean_B<mean_H. By Currier language: AZC(-1.59) > B(-1.40) > A(-0.82). z_mu controls for vocabulary size. REGIME-mediation caveat (C1404): S dominated by REGIME_3/REGIME_4. Length-confound caveat (C1997): partly mediated by section-typical folio length. A weakest consistent with C233 (LINE_ATOMIC), C234 (POSITION_FREE). AZC strongest consistent with C302, C311, C313 (positional grammar). Descriptive measurement; functional interpretation reserved as Tier 3 follow-up.	2	GLOBAL, section, transition-graph, z-mu, ordering, KW-test, C1404-flagged, C233, C234, C302, C311, C313	KW_H=27.7. KW_p=0.0001. B_vs_H_mwu_p=0.0003. S_mean=-2.04. C_mean=-1.96. B_mean=-1.95. H_mean=-0.30. AZC_mean=-1.59. CB_mean=-1.40. CA_mean=-0.82.
C2000	daiin state-flush hypothesis REJECTED; no positive characterization of daiin's MI regime established. Pre-registered Phase 687 prediction: MI(prev; next | T=daiin) below population median AND below significance threshold z<+1.0. T1 FAILS (daiin z=+0.76 at 67th percentile of 72 eligible tokens, ABOVE median z=-0.11). T2 PASSES (daiin z<+1.0, MI not significantly above shuffle null). T3 PARTIAL (dar z=+0.91 above median, saiin z=-0.41 below). T4 PASSES (qokedy z=+2.51, shedy z=+2.07 confirm methodology detects context propagation). The state-flush hypothesis is rejected as a directional prediction; daiin is statistically indistinguishable from population median (|z-median|<2). NO POSITIVE CHARACTERIZATION is established by this test — daiin is neither a low-MI state-flush operator nor a high-MI context-propagating operator at the resolution measured. T3 PARTIAL means class-level test (C2001) NOT registered per pre-reg. Auxiliary observation (NOT registered): in broader population, MI z appears to correlate with token complexity (long compound tokens qotar +3.95, chol +3.17, qokedy +2.51 are top; short stems qokal -1.31, shey -1.24, al -0.95 are bottom) — observation only. REVISED 2026-05-07 (hygiene pass): original framing "daiin is moderate-context-propagation" converted a non-rejection into a positive characterization; revised text retains only the directional rejection.	2	B, falsification, NULL, daiin, state-flush, mutual-information, MI, no-positive-characterization, C557, C998, C1998, hygiene-revised	daiin_z=+0.76. dar_z=+0.91. saiin_z=-0.41. median_z=-0.11. n_eligible_tokens=72. daiin_n_triplets=314. daiin_distinct_prev=232. daiin_distinct_next=203. daiin_MI_actual=6.585. daiin_MI_null=6.581. T1=FAIL. T2=PASS. T3=PARTIAL. T4=PASS. qokedy_z=+2.51. shedy_z=+2.07. revised_2026-05-07.
C2001	qokedy cross-tier MI persistence — qokedy MI is non-collapsing under qo-family removal. Pre-registered Phase 688 hypothesis: MI(prev; next | T=qokedy) restricted to (prev, next) pairs where neither is qo-prefix has z > +1.0. T1 PASSES at z_cross=+2.49 (n=140 cross-tier triplets out of 271 total). Cross-tier z is HIGHER than qo-cluster (z=+1.34, n=19 INSUFFICIENT) and boundary (z=+1.26, n=112). MORPHOLOGICAL-CLUSTERING HYPOTHESIS REJECTED — cross-tier MI does not collapse. Mechanism for residual cross-tier MI elevation (operational, recipe-structural, REGIME-conditioning per C979, section-conditioning per C1029, category-routing per C1286, or other) is not isolated by this test and is reserved as Tier 3 interpretation (see C2003). Auxiliary T4 (NOT registered): Phase 687 overall MI z-ranking does NOT predict cross-tier persistence. CAVEAT (Phase 689 C2002): the "morphological clusterer" framing for qotar/chol was further refuted at same-stem density level. REVISED 2026-05-07 (hygiene pass): original "operational embedding CONFIRMED" framing smuggled mechanism interpretation; revised text retains only the measurement (cross-tier MI persistence) and the directly-tested rejection of morphological clustering.	2	B, qokedy, mutual-information, cross-tier-persistence, morphological-clustering-rejected, three-tier-decomposition, C1300, C1394, C1965, C1988, C1995, C1971, PT-013, C2003, hygiene-revised	qokedy_n_triplets=271. cross_n=140. cross_MI=5.292. cross_null=5.249. cross_z=+2.49. cluster_n=19_INSUFFICIENT. cluster_z=+1.34. boundary_n=112. boundary_z=+1.26. T1=PASS. T2=INSUFFICIENT. T4_chcthy_cross_z=+3.78. T4_qotar_cross_z=-0.20. T4_chol_cross_z=-0.23. revised_2026-05-07.
C2003	qokedy operational-embedding candidate (Tier 3 interpretation of C2001 measurement). The cross-tier MI persistence in C2001 (z=+2.49) is consistent with qokedy carrying recipe-structural information that survives qo-family ablation. The morphological-clustering alternative was directly tested and rejected (C2001). Remaining mechanism candidates: (a) operational/recipe-structural embedding (predecessor predicts successor through qokedy via recipe sequence), (b) REGIME-conditioning per C979, (c) section-conditioning per C1029, (d) category-routing per C1286, (e) other multi-causal joint structure. Direct test of recipe-structural embedding hypothesis would require alignment of qokedy positions with matched-recipe phase ordinals (per C1971/C1965/C1988 framework), not yet performed. Consistent with PT-013 (qokedy="maintain fire level"), C1300 (qo=100% k-HEAD thermal channel), C1394 (HEAD+MOD*+TERM atom model). Operational-embedding interpretation is a directional hypothesis for future phases; not promoted to Tier 2 without source-aligned or atom-functional confirmation.	3	B, qokedy, operational-embedding-candidate, interpretation, recipe-structural, C2001, C979, C1029, C1286, C1971, C1965, C1988	cross_z_C2001=+2.49. mechanism_candidates=4plus. confirmation_pathway=source_alignment_or_atom_functional. tier=3_interpretation_of_T2_measurement.
C2004	AZC annotation-transcript audit summary. Of 26 user-annotated AZC folios audited against H-track transcript (sample: 13 annotation files in data/folio_annotations/azc/), 20 (77%) show non-zero discrepancy on at least one of three measures. 17/26 (65%) total-token diff. 9/26 (35%) center-token diff. 1/26 ring-layer diff. Methodology: H-track only, uncertain tokens excluded, center detection via placement codes C/C1/C2/W/I/B. AZC transcript encoding has documented gaps relative to user visual inspection at scale; concentrated by folio per C2005.	2	AZC, audit, transcript-encoding, annotation-diff, measurement, gaps, C302, C311, C313	n_folios=26. n_flagged=20. flagged_pct=77pct. n_total_diff=17. n_center_diff=9. n_ring_diff=1.
C2005	Nymph-page center-token systematic gap in H-track transcript. Of 26 audited AZC folios, 9 show user-observed center tokens that H-track transcript does not encode under center placement codes. ALL 9 are user > transcript direction. 8 of 9 are nymph-page folios (f70v-f73r). Hypergeometric p ~0.0023 for nymph-concentration; binomial p ~0.0039 for same-sign direction. Specific candidate transcript-error folios: f70v2, f70v1, f71r, f71v, f72r1, f72r2, f72r3, f72v1, f73r. Mechanism reserved (Tier 2 measurement only): could be transcriber methodology, missing transcription, alternate placement codes, or user mis-counting. Direct verification requires hires scan inspection or independent OCR. Natural validation target if OCR project undertaken.	2	AZC, nymph-page, center-token, transcript-gap, systematic, candidate-errors, audit, C302, C311, C313, OCR-target	n_center_diffs=9. nymph_concentration=8of9. hypergeometric_p=0.0023. direction_p_binomial=0.0039. all_user_gt_transcript=true. candidate_folios=9. mechanism=reserved.
C2002	qotar cross-tier MI collapse mechanism — three pre-registered candidates FALSIFIED. Phase 689 NULL result. T1 (same-stem density >30% per C1995 Section S compactness): observed 1.7% (2/121 adjacent positions). T2 (folio Gini >0.70): observed 0.684. T3 (S/C section concentration chi^2 p<0.01 AND ratio>1.5): observed chi^2=5.39, p=0.25, ratio=1.15. None of three mechanisms predicted by C1995/C1404 explain qotar's clustering. Surprising counter-finding (T4 partial): qokedy (operational embedder per C2001) has 9.2x higher same-stem density (15.7%) than qotar (alleged morphological clusterer at 1.7%) — opposite of Phase 688's framing. The cross-tier z=-0.20 measurement is preserved; the "morphological clustering" mechanism inference is refuted at same-stem level. Likely actual mechanism (NOT registered): qotar's neighbors dominated by o-prefix family (otal, okar, okedy, otedy) but not same-stem; junction/marker function via t-HEAD=transfer + r-TERM=respond per C1394 atom decomposition, distinct from qokedy's iterative thermal-cycle role (k-HEAD=heat). Methodological lesson: cross-tier MI z is a measurement, not a mechanism — see feedback_measurement_vs_mechanism.md.	2	B, qotar, NULL, falsification, mechanism, same-stem-density, folio-Gini, section-concentration, C1995, C1404, C1962, C2001	qotar_n=61. n_adjacent=121. same_stem_frac=1.7pct. folio_Gini=0.684. section_chi2=5.39. section_p=0.25. SC_ratio=1.15. T1=FAIL. T2=FAIL. T3=FAIL. T4=PARTIAL. qokedy_same_stem=15.7pct. qokedy_self_iteration_28x.
...
C2027	[RETRACTED 2026-05-16 to Tier 1] Originally claimed heat-cycle MIDDLE-class adjacency chains UNIQUE to PL-matched Section S folios, corroborating iteration-encoding mechanism. Pre-registered discriminating control on 2026-05-16 (family-stratified shuffle null + cross-group comparison) falsified three of four pillars: (a) matched-S unique framing FALSE — both matched-S +0.034 and unmatched-S +0.044 show heat-cycle excess at comparable strength across length filters; (b) iteration-encoding mechanism PARTIALLY FALSE — iteration markers (aii/daiin) show near-zero adjacency (+0.001 corpus, 0 adjacent pairs across 4 folios); chain signal is in heat-cycle specifically AND closure-class (late_term) markers NOT iteration markers; (c) baseline +0.0037 decomposes into heat_cycle +0.026 + late_term +0.038 family-stratified — late_term contribution missed in original framing. Replaced by C2028 (Section S vs Section B heat-cycle divergence), C2029 (daiin doesn't chain — measurement only), C2030 (late_term Voynich-wide). Preserved as Tier 1 retraction for audit traceability.	1	RETRACTED, FALSIFIED, iteration_encoding_mismatched, framework_as_null_caught, audit_2026_05_16, C2028, C2029, C2030	retracted_date=2026-05-16. original_tier=2. correction_constraints=C2028+C2029+C2030.
C2028	Section S vs Section B Heat-Cycle MIDDLE-Class Adjacency Divergence. Length-controlled within-paragraph shuffle null on MIDDLE-class first-3-chars lag-1 adjacency stratified by class family. Heat-cycle MIDDLE classes (kee/ee — the qokee* family) cluster adjacently in Section S folios but not Section B. Section S matched +0.034 (20-100), +0.037 (≥10), +0.060 (50-150). Section S unmatched +0.044, +0.044, +0.093. Section B near-zero across all length filters: +0.003 to +0.006. Section-level structural distinction, NOT matched-folio-level — both matched and unmatched Section S folios show signature at comparable or higher strength. Survives stricter within-line shuffle null (+0.026 within-line vs +0.034 within-paragraph at matched-S, length 20-100; delta only +0.008). Cross-references heat-cycle iteration encoding at atom level (C1394 e MOD = thermal microstate) and anchor level (C1969 ×9 anchor on f75r). Refines C2027's matched-folio framing to correct Section-level scope.	2	heat_cycle, MIDDLE_class_adjacency, Section_S_signature, Section_B_negative, structural_divergence, within_line_null, C1394, C1969, C1971	matched_s_heat_cycle_excess_20_100=+0.034. unmatched_s_heat_cycle_excess_20_100=+0.044. section_b_heat_cycle_excess_20_100=+0.003. within_line_excess=+0.0255. within_paragraph_excess=+0.0340. n_perm=200.
C2029	Iteration Markers (aii / daiin Family) Do NOT Chain at Adjacency. Across 4 daiin-heavy matched-S folios tested (f114r×11, f112v×6, f106v×3, f103r insufficient), zero pairs of daiin tokens occur in adjacent positions. Corpus-level aii MIDDLE-class adjacency excess +0.001 under within-paragraph shuffle null. Distributional measurement-only — no mechanism inference for what daiin does positionally. Resolves measurement-vs-mechanism asymmetry in prior literature: C1953 documents daiin×N count-clustering at folio/paragraph level, but count-clustering and adjacency-clustering are independent measurements. Daiin distribution within paragraphs varies by folio (f114r late-biased 0.455 late-quarter, f112v mid-range 0.333, f106v early-biased 0.000). Single-folio late-position bias on f114r does not generalize per pre-registered multi-folio replication test (1/3 folios pass late-bias criterion). C2029 registers only chaining-null measurement; phase-boundary observation stays Tier 4 memory pending more data.	2	iteration_markers, daiin_no_chain, aii_class_null, measurement_only, no_mechanism, distinction_from_count_clustering, C1953, C2000, C2001, C2002	aii_adjacency_excess_corpus=+0.001. n_folios_tested=4. n_with_sufficient_data=3. adjacent_pairs_total=0. multi_folio_late_bias_pass=1of3. n_perm=200.
C2030	Voynich-Wide Late-Term MIDDLE-Class Adjacency Clustering Within-Line. LATE-class MIDDLE families (ar, ary, aly, al — closure/output-terminal markers per C539/C562) chain adjacently at +0.036 within-line excess. Voynich-wide pattern: matched-S +0.038, unmatched-S +0.017, Section B +0.041. Survives stricter within-line shuffle null (preserves line membership and position): late_term within-line excess +0.0365 vs within-paragraph excess +0.0391, delta only +0.0026. Clustering is genuine token-sequence within-line adjacency, not purely line-boundary positional artifact. Scope: within-line shuffle controls within-line position but does NOT control for cross-line adjacency at line boundaries. Cross-references C1235 (line-final routing) and C539 (LATE class line-final concentration) as related but distinct phenomena. Predicts (NOT tested): closure protocols may have internal bigram grammar (directional or→al ≠ al→or asymmetries, forbidden LATE-LATE pairs parallel to C109).	2	late_term, closure_protocol, MIDDLE_class_adjacency, within_line_null, Voynich_wide, C1235, C539, C562	late_term_within_line_excess_matched_s=+0.0365. late_term_within_paragraph_excess_matched_s=+0.0391. delta=+0.0026. n_pairs_matched_s=423. n_perm=200. scope=within_line_adjacency.
...
C2037	AZC-Diagram-Token Placement Contamination Correction. Pre-registered H3 test (hapax > n_2_3 paired sign test on top-decile folios) verdict depends on placement filter choice. P-only filter: 6/8 p=0.14 FAIL. P+L (paragraph + labels): 6/8 p=0.14 FAIL — identical to P-only, labels alone do NOT contaminate. All-placement (P+L+R+S+C+X+Y+N+T): 7/8 p=0.035 PASS. The verdict flip is driven specifically by AZC diagram tokens (R rings, S stars, C circles, X, Y, N, T), NOT by labels. Diagnostic: hapax cohort grows from 820 (P-only) to 866 (all-placement), and the 46 added hapaxes are MIDDLEs appearing exactly once on diagram positions (and nowhere else in B paragraphs/labels). These AZC diagram singletons have categorically different distributional properties per AZC architecture (C300-series), concentrate on diagram-heavy folios, and artificially inflate per-folio enrichment ratios there. For MIDDLE inventory or per-folio frequency analyses on paragraph-text content, defensible standard placement filter is P+L (equivalent to P-only for this purpose); all-placement contaminates with AZC diagram tokens. PHASE_699 v2 H3 PASS verdict was AZC-token-contamination artifact, not paragraph-text signal.	2	methodology, placement_filter, AZC_contamination, MIDDLE_inventory, hapax_cohort_definition, C300, C1135	n_hapax_p_only=820. n_hapax_p_plus_l=820. n_hapax_all_placement=866. delta_azc_hapaxes=46. h3_p_only=0.1445_FAIL. h3_p_plus_l=0.1445_FAIL. h3_all_placement=0.0352_PASS. flip_attribution=AZC_tokens_R_S_C_X_Y_N_T. defensible_filter=P_plus_L.
C2038	Low-Frequency Hapax-Band Corpus Census. Distributional measurement: Currier B has 866 corpus-wide hapax MIDDLEs (all-placement filter, H-track non-uncertain). C1135 unmatched-PP MIDDLE set ("dark pipeline," 300 MIDDLEs, mean 5.7 tokens, section-concentrated Herf=0.716) has heavily-skewed frequency distribution: median frequency=3, 60% of catalogued MIDDLEs at n≤3, 28% at n=1 (hapax frequency band). 70 corpus-wide hapax MIDDLEs (sample of 866) overlap with C1135's catalog under exact MIDDLE-string match. 96% (67/70) of these overlap MIDDLEs occur on P-placement (paragraph text); 0/70 occur on R (ring) placement; <5% on combined C/X/T placements. **Distributional census only.** The 70-MIDDLE overlap is consistent with C1135's own frequency profile (the catalog already documents a long low-frequency tail extending to hapax band) and does NOT constitute independent association evidence beyond what C1135's frequency profile implies. Within-folio shuffle null on the rate-correlation form (see C2039) demonstrates per-folio relationship is composition shadow, not hapax-specific.	2	distributional_census, hapax_corpus_wide, low_freq_band, MIDDLE_inventory, no_association_claim, C1135, C1137, C1140	n_hapax_corpus_wide=866. n_dark_pipeline_total=300. n_dark_pipeline_present_in_B=252. n_hapax_dark_overlap=70. fraction_overlap_p_placement=96pct. dark_pipeline_median_freq=3. dark_pipeline_n_le_3_pct=60. dark_pipeline_n_eq_1_pct=28. measurement_only=yes. independent_association_claim=NO.
C2039	Hapax×Dark Rate vs Hapax Enrichment Correlation Is Composition Shadow. Per-folio analysis: hapax×dark-pipeline rate vs hapax enrichment gives raw Pearson r=0.557, TTR-controlled partial r=0.395. Within-folio shuffle null (200 permutations preserving per-folio token counts and global MIDDLE frequency distribution): observed partial r vs null mean 0.286 (SD 0.119) gives z=0.91, p=0.18. Signal does NOT survive within-folio shuffle null. Folio-composition shadow, NOT hapax-specific association beyond TTR + composition. Notable secondary: raw r=0.56 gives z=2.30 (nominally significant), but TTR control absorbs half the signal and within-folio shuffle absorbs the rest (z_raw=2.30 → z_partial_TTR_plus_within_folio_null=0.91). Third documented within-folio-null falsification in +0.4-aggregate-rho pattern, following k-e-depth thermal regimes and triple-i ↔ iter-terminal (both 2026-05-11). Reinforces feedback_within_folio_shuffle_null_first.md: aggregate rho in +0.15 to +0.65 range with no within-folio null is the documented composition-shadow signature; PHASE_699 confirms this for the third time. Specific lexical-content-tail interpretations (PHASE_698 crazy-expert proposal of hapaxes as material/parameter identifiers) NOT supported by per-folio rate analysis at corpus scale.	2	within_folio_shuffle_null, composition_shadow, lexical_content_tail_falsification, third_documented_case, methodology_validation, C2038, C1135	observed_partial_r_ttr_controlled=0.3943. null_mean_partial=0.2859. null_sd_partial=0.1187. z_score_partial=0.91. p_value=0.18. observed_raw_r=0.5623. null_mean_raw=0.2847. z_raw=2.30. n_perms=200. third_within_folio_null_falsification=yes. precedents=k_e_depth_thermal_regimes_2026_05_11_AND_triple_i_iter_terminal_2026_05_11.
C2040	Six Medieval Periodic-Notation Alternative Classes EXCLUDED via Peak-Specificity Test. External adversarial corpus test. Synthetic corpora generated for canonical medieval periodicities: Weekly (P=7), Zodiac (P=12), Indiction (P=15), Computus Metonic (P=19), Solar dominical (P=28), Lunaria (P=30). Each shows peak-specificity ≈ +1.0 at target lag by construction. Peak-specificity metric: agreement_rate(P) − mean(agreement_rate at lags P±1..±4). Discriminates SHARP cyclic peak (synthetic) from UNIFORM topical elevation (NL Mesue ≈ 0 across all periods). Voynich Section B and matched-S tested on each period: peak-specificity ranges from -0.18% to +0.36% of synthetic baselines across all 6 classes, statistically indistinguishable from NL Mesue. All 6 classes EXCLUDED (Voynich peak-specificity < 10% of synthetic threshold). Multiple-comparisons: 0/6 false positives observed (vs 0.3 expected at p<0.05 nominal). Scope limit: peak-specificity metric appropriate for periods ≥ 7 where ±4 neighborhood window doesn't catch period multiples; period-2 case has secondary-peak-in-neighborhood artifact (Voynich Section B period-2 specificity reads 0.86% of synthetic due to lag-4 secondary peak inclusion). Voynich's known period-2 grammar (C2032 lag2/lag1=-0.66, z=6.7) remains confirmed via C2032's lag-ratio methodology, NOT via peak-specificity. Combined with mensural falsification (C2032 cross-language test, 2026-05-16), brings cumulative alternative-class falsification series to 7 medieval periodic notational systems excluded. Bounded scope: measurement-level claim about these 6 specific periodicity classes; does NOT claim "Voynich isn't notation" or "Voynich is unique."	2	external_adversarial, alternative_class_exclusion, peak_specificity, multi_class_sweep, computus_falsified, mensural_followup, C2031, C2032	n_periods_tested=6. periods=7_12_15_19_28_30. synthetic_specificity=+1.000_all. mesue_specificity_max_absolute=0.0006. voynich_sb_specificity_max=+0.0021. voynich_ms_specificity_max=+0.0036. sb_share_of_synthetic_range=-0.15_to_+0.21pct. ms_share_of_synthetic_range=-0.18_to_+0.36pct. exclusion_threshold=10pct_share. all_6_excluded=yes. observed_false_positives=0. expected_false_positives_at_p05=0.3. floor1_synthetic_pass=yes. floor2_nl_metric_specificity_fail_resolved_by_refinement=yes. period_2_scope_limit_documented=yes. mensural_series_total_exclusions=7.
C2041	LATE-Class Closure Protocol Directional Asymmetry (ar -> al). PHASE_703 refines C2030's within-line LATE clustering by examining bigram-level directional structure. LATE inventory (locked pre-test, 12 MIDDLE strings from C539/C562): ar, ary, aly, al, dar, dal, dary, daly, or, ory, oly, ol. Method: Currier B P-placement, extract LATE-LATE adjacent bigrams within-line. Test 1 directional asymmetry via binomial p (null=0.5 under within-line shuffle) with Benjamini-Hochberg FDR + 30% effect-size floor. Test 2 forbidden bigrams via observed=0 + within-line shuffle null expected >=5 + empirical p<0.005. Pre-registered combined criteria: Tier 2 if both pass, Tier 3 if exactly one, no constraint if neither. Results: 320 LATE-LATE bigrams across 17 unique types observed in 2299 within-line sequences. 6 unordered pairs met N>=5 FDR floor. ONE pair passes: ar -> al = 39, al -> ar = 14, asymmetry +0.472, p_raw=0.0008, p_BH=0.0048, both FDR-significant and effect-size-floor-passed. Three near-miss pairs at +0.23 asymmetry consistent toward ol as later-position (ar->ol 27/17, al->ol 16/10, or->ol 16/10) but FDR-fail at current N. Forbidden test INCONCLUSIVE: 320 bigrams across 144 possible 12x12 types yielded mean expected per type ~2, below pre-registered >=5 floor; zero qualifying candidates; this is data sparseness not negative result. Verdict: Tier 3 per locked combined criteria. Refines C2030 by adding directional sub-structure. Operationally suggests closure protocol has ordered structure (ar precedes al ~2.8x more often than reverse); interpretation candidate deferred to SPECULATIVE pending external grounding. Within-line shuffle null implicitly controls positional artifacts. PHASE_705 SHARPENING (2026-05-19): Terminal-atom generalization test examined whether ar->al is one instance of broader r-terminal -> l-terminal class grammar. Aggregate r-class (ar/dar/or) -> l-class (al/dal/ol) = 94 vs 51, asymmetry +0.297, p_BH=0.0018, N=145 passed pre-registered Test A. But per-pair direction test failed strict 6/9 (5/9 r->l, 4 empty all dar/dal-involving). Crazy-expert prevailed: aggregate inherits C2041 signal -- removing ar->al pair yields r->l=55 vs l->r=37, asymmetry +0.196, p~0.06 NOT significant. Load-bearing diagnostic: or->al at +0.05 (N=21) near-symmetric -- if class-grammar held, all observable r×l should be asymmetric, they aren't. Pattern is ar-lexeme-specific (ar prefers al, ol) + ol-as-late-destination (both ar->ol and or->ol show +0.23). y-class members of C2030 inventory (ary/aly/etc) are morphology artifact -- parsed as MIDDLE=ar/ol + SUFFIX=y, only 1 y-class MIDDLE token in entire Currier B P. C2041 sharpened: NOT "LATE-class directional grammar" but "ar-lexeme directional preference + ol-as-late-destination." PHASE_705 closed INDEX-only, no C2042 registered.	3	late_term, closure_protocol, directional_asymmetry, MIDDLE_class_bigrams, within_line_null, FDR_corrected, refinement_of_C2030, lexeme_specific_not_class_grammar, ol_as_late_destination, C2030, C539, C562, C886, C109	n_late_late_bigrams=320. n_lines_collected=2299. n_unique_bigram_types_observed=17_of_144. n_pairs_at_N_floor_FDR=6. n_asymmetries_passing=1. n_forbidden_passing=0_inconclusive_data_sparseness. ar_to_al_count=39. al_to_ar_count=14. asymmetry=+0.4717. binomial_p_raw=0.000802. p_BH=0.00481. effect_size_floor=0.30_passed. fdr_threshold=0.05_passed. near_miss_pairs_consistent_ol_later=ar_ol_27_17_al_ol_16_10_or_ol_16_10. forbidden_test_data_sparseness=expected_per_type_lt_5. pre_registered_combined_criteria=tier3_when_exactly_one_test_passes. phase_705_aggregate_r_to_l=94. phase_705_aggregate_l_to_r=51. phase_705_aggregate_asymmetry=0.297. phase_705_aggregate_pBH=0.0018. phase_705_aggregate_minus_C2041_p=0.06. or_al_near_symmetric=0.05_N21. ar_ol_asymmetric=0.23_N44. or_ol_asymmetric=0.23_N26. y_class_morphology_artifact=1_token_total. no_C2042_registered.
C2042	Voynich Atom-Layer Vocabulary Categorical-Homogeneity. PHASE_710 (2026-05-20). Project's existing 18-atom inventory (C1195 ATOM_GLOSSES) classified by gloss semantic category: OPERATION (action-role) vs ENTITY (thing/value) vs PROPERTY (quality/state) vs FUNCTION (grammatical glue) vs AMBIGUOUS_OP_* (operation-or-entity/property dual-glossable). 13/18 atoms unambiguously OPERATION-role (k=heat, e=cool, h=watch, y=end, i=iterate, n=bind, a=yield, d=do, t=transfer, o=arrange, c=adjust, p=pause, r=respond); 5/18 ambiguous (m=final OP/PROP; l=state OP/ENT; f=flag OP/ENT; s=sequence OP/ENT; x=diagram OP/ENT); 0/18 unambiguously ENTITY-pure, PROPERTY-pure, or FUNCTION-pure. H_OPERATION = 72% strict (op-pure only) to 100% inclusive (treating ambiguous atoms as project uses them operationally). Comparison corpora: (a) Latin Codicillus top-50 word-forms cleaned of OCR fragments = 12% OPERATION, 54% ENTITY-dominant; (b) Latin productive morpheme inventory ~46 derivational + inflectional suffixes (Allen/Gildersleeve reference) = 15% OPERATION, 43% FUNCTION-dominant; (c) Mensural duration classes (8 items from MEI corpus) = 0% OPERATION, 100% ENTITY (floor control); (d) Forth CORE wordset (57 items) = 100% OPERATION (tautological positive control by design); (e) x86 base instructions (56 items) = 100% OPERATION (tautological positive control by design). Load-bearing contrast: Voynich atom-layer has 0/18 non-operational atoms vs Latin morpheme inventory's ~85% non-operational morphemes (FUNCTION 20, ENTITY 11, PROPERTY 8 of 46) — zero-count asymmetry at any reasonable sampling. Categorical signature distinguishes Voynich's atom-layer from NL morpheme inventories (heterogeneous-categorical) and from non-operational symbolic systems (mensural). Pre-registered three-axis discriminating test all passed. Scope caveats baked into constraint: (1) Result reported as 72-100% band, not 100% — inclusive upper bound depends on gloss judgment for 5 ambiguous atoms. (2) Category assignments are hermeneutic (glossing judgment), placing this at Tier 3 not Tier 2. (3) Signature distinguishes "operational" from "non-operational" categorically; does NOT specifically prove "procedural DSL" — could equally fit operational specification language or taxonomic classification system. (4) Forth/x86 positive controls tautological; load-bearing comparison is Voynich-vs-Latin and Voynich-vs-mensural. (5) Mechanism interpretation ("Voynich IS a programming language") remains Tier 4 SPECULATIVE per `feedback_mechanism_cycle_procedural_ceiling.md`. (6) Framework-as-null discipline applied: result fits Tier 0 closed-loop-control framing cleanly (yellow flag), but specific zero-counts are sharp enough to be discriminating measurement not framework-echo. (7) Atom glosses computed via project's 7-axis battery framework — Voynich-side category assignment carries some framework baggage; mensural and Latin baselines externally grounded. Refines/extends C1195 (atom gloss inventory), C1003 (pairwise compositionality), C1190/C1191 (MIDDLE atomicity), C1394 (HEAD+MOD*+TERM template). Does NOT conflict with C171 (semantic ceiling) — claim is about ROLE-category not lexical-meaning content.	3	atom_layer, categorical_homogeneity, operational_role, gloss_classification, comparison_to_NL_morphemes, mensural_floor_control, programming_language_analog, tier3_glossing_hermeneutic, expert_scrutiny_applied, C1195, C1003, C1190, C1191, C1394, C171	n_voynich_atoms=18. h_op_strict=72.22pct_13_of_18. h_op_inclusive=100pct_with_5_ambiguous. ambiguous_atoms=m_l_f_s_x. n_op_pure=13. n_entity_pure=0. n_property_pure=0. n_function_pure=0. latin_top50_wordforms=N50_12pct_op_entity_dominant. latin_morpheme_inventory=N46_15pct_op_function_dominant. mensural=N8_0pct_op_entity_dominant. forth_core=N57_100pct_op_tautological_pos_control. x86_base=N56_100pct_op_tautological_pos_control. load_bearing_comparison=voynich_vs_latin_morpheme. zero_count_asymmetry=0_voynich_non_op_atoms_vs_85pct_latin_morphemes_non_op. tier=3_hermeneutic_glossing. framework_as_null_warning=triggered_but_mitigated. scope_caveat_procedural_dsl_vs_operational_specification=not_distinguished. expert_corrections_applied=4. mechanism_interpretation_blocked_at_tier4=yes.
C2043	Atom-Level Slot Features Carry Forward-Predictive Information Beyond 49-Class Label (Sub-Class Refinement). PHASE_711 main test (2026-05-20). Crazy-expert PHASE_710 follow-up proposal. 10,111 within-line adjacent (current, next) token pairs in Currier B P-placement where both tokens have C121 49-class labels. 5-fold folio-out CV with three model architectures, all multinomial LogReg with L2 regularization (apples-to-apples calibrated comparison): Markov reference (class-only empirical) CE=4.8785 / Acc@1=13.67%; LogReg class-only baseline CE=4.7597 / Acc@1=13.76% / Acc@3=30.5%; LogReg slot model (class + 6 slot features: prefix_cat, e_depth ∈{0,1,2,3+}, head_atom, term_atom, has_suffix, suffix_first) CE=4.6903 / Acc@1=16.12% / Acc@3=33.6%; Shuffle control (same architecture, slot features randomly permuted) CE=4.8377 / Acc@1=13.17%. Slot model improves over class-only baseline by +0.0693 bits CE / +2.36pp Acc@1 / +3.1pp Acc@3, replicating 5/5 folds with consistent direction. Slot model beats shuffle control by +0.1473 bits CE / +2.95pp Acc@1 — rules out overfitting. Pre-registered thresholds locked before test: CE improvement ≥0.05 bits PASS, real gain over shuffle ≥0.04 bits PASS, accuracy improvement ≥2pp PASS. All three axes triggered PARAMETER-SLOT INFORMATIVE verdict. Scope: measurement of forward-predictive value of slot features beyond class label; effect size modest 1.5pct of total CE but consistent and survives shuffle control by 2x margin. Initial methodology note: first run used HistGradientBoosting which gave PATHOLOGICAL verdict due to GBM probability miscalibration; re-run with calibrated LogReg gave clean apples-to-apples verdict. Refines C1025 by showing slot features provide additional forward-predictive value but does NOT beat M2 generative sufficiency (different metric). No conflict with C1004 — slot features provide within-C121 sub-class refinement, not new architectural layer. Mechanism interpretation registered separately as C2044 (rejected parametric reading).	2	parameter_slot_decoding, sub_class_refinement, forward_prediction, CE_improvement, shuffle_control, 5_fold_folio_CV, calibrated_LogReg, C121, C1025, C1004, methodology_calibration_lesson	n_pairs=10111. n_folios=80. ce_baseline_LR=4.7597. ce_slot_LR=4.6903. ce_shuffle=4.8377. ce_improvement_vs_baseline_LR=+0.0693. ce_gain_vs_shuffle=+0.1473. acc1_slot=0.1612. acc1_baseline_LR=0.1376. acc1_shuffle=0.1317. all_3_axes_pass=yes. five_fold_consistent=yes. effect_size_modest=1.5pct_total_CE. methodology_initial_GBM_miscalibrated=yes. methodology_logreg_apples_to_apples=yes.
C2044	Parametric-Semantics Interpretation of Slot Features REJECTED by Pre-Registered Diagnostics. PHASE_711 follow-up. Crazy-expert pre-registered TWO discriminating tests in PHASE_710 follow-up speculation to distinguish "atoms function as opcodes + operands with parametric semantics" from "atoms function as sub-class labels refining C121 partition." Both tests REJECT parametric reading. Test 1 — Within-class retention: For each of top-10 most-frequent current-classes, held class fixed and tested if slot features add WITHIN-class forward-predictive value. Crazy-expert thresholds: >50pct retention of full-slot gain → parametric survives; <20pct → sub-class refinement wins. Result: 7/10 classes show full-slot model PERFORMS WORSE than marginal baseline within fixed class (class 13 -0.009, class 8 -0.277, class 31 -0.395, class 32 -0.297, class 29 -0.084, class 14 -0.470, class 9 -0.463); only class 33 had positive full-slot gain (+0.034) but e-depth alone beat full-slot there. Slot features have no within-class predictive value; PHASE_711 main test 0.07 bits gain comes entirely from BETWEEN-class differentiation. Test 2 — Feature importance ordering: Crazy-expert prediction if parametric: HEAD atom dominates >> e_depth >> TERM atom >> suffix_first; HEAD vs prefix_category ratio >2x signals parametric. Observed per-dim L1 coefficient norms from full slot LogReg: TERM atom 17.62, suffix_first 15.28, prefix_cat 12.81, HEAD atom 12.33, e_depth 11.15. HEAD is 4th of 5; HEAD/prefix_cat ratio = 0.96 (essentially equal, NOT >2x toward parametric). TERM and suffix dominate — exactly the CLOSURE features that define class membership per C1487 and C1510. Both pre-registered discriminators converge on sub-class refinement, away from parametric. Crazy-expert accepted rejection in registration consultation: "Both pre-registered diagnostics fired against me ... feature ranking with TERM > suffix_first > prefix_cat ≈ HEAD is the death blow for parametric: if HEAD were the opcode and other slots were operands, HEAD should dominate. It doesn't ... I lose." Implication: crazy-expert PHASE_710 maximum-claim "Voynich is microcode-like with parametric instructions" retracts one rung. Atoms have differentiated categorical signatures (DSL-like SHAPE per C2042) but do NOT parametrically modulate next-instruction selection (NOT DSL-like SEMANTICS). Shape-without-semantics framing is the new ceiling. Mechanism inference "atoms function as opcodes with operand parameters" returns to Tier 4 SPECULATIVE. Weakest survivable form per crazy-expert: localized parametric semantics in specific frames (e→y per C1457, o-HEAD compositional determinism per C1556) — but these are already covered by existing constraints, not substrate-level claim. C2042 atom-layer categorical signature unaffected — that's about gloss categorization independent of forward-predictive mechanism. Tier 0 (closed-loop control programs) unaffected — substrate framing survives, only specific mechanism inference falls. Framework-as-null discipline validated: crazy-expert own pre-registered tests rejected crazy-expert hypothesis. Per feedback_expert_predictions_are_pre_registrations.md and feedback_framework_as_null.md, this is methodology working as designed. Scope caveats: (1) within-class test had small N per class with several degenerate retention-undefined outcomes; "rejected by pre-registered diagnostics" not Tier 1 FALSIFIED — save Tier 1 for unambiguous well-powered discriminators per expert-advisor scrutiny. (2) Feature importance interpretation depends on L2 regularization choice; ranking stable across reasonable C-values but exact magnitudes vary. (3) Sub-class refinement vs new architectural layer distinction: this is refinement WITHIN C121 partition, NOT a fourth architectural layer (no conflict with C1004).	2	mechanism_rejection, parametric_semantics, sub_class_refinement_wins, pre_registered_discriminators, framework_as_null_validation, methodology_discipline_working, C2042, C2043, C1004, C1003, C1024, C1487, C1510, C1475, C631, C506.b, feedback_expert_predictions_are_pre_registrations, feedback_framework_as_null	n_top_classes_tested=10. n_classes_with_negative_full_slot_gain=7. n_classes_with_positive_gain=1. class_33_full_slot_gain=+0.034. class_33_edepth_gain=+0.049. class_13_full_slot_gain=-0.009. class_8_full_slot_gain=-0.277. class_31_full_slot_gain=-0.395. class_32_full_slot_gain=-0.297. class_29_full_slot_gain=-0.084. class_14_full_slot_gain=-0.470. class_9_full_slot_gain=-0.463. feature_importance_per_dim_TERM=17.62. feature_importance_per_dim_suffix_first=15.28. feature_importance_per_dim_prefix_cat=12.81. feature_importance_per_dim_HEAD=12.33. feature_importance_per_dim_e_depth=11.15. HEAD_vs_prefix_ratio=0.96. crazy_expert_predicted_HEAD_dominates_by_2x=NO. crazy_expert_accepted_rejection=yes. parametric_mechanism_to_tier_4=yes. C2042_unaffected=yes. tier_0_unaffected=yes. shape_without_semantics_framing=new_ceiling.
C2045	C645 Sharpening: Substrate-Level Single-Step Post-Hazard Cooling Bigram (Class-Agnostic, No Continuation). PHASE_714 (2026-05-20). 5-axis refinement of C645 (post-hazard CHSH dominance Tier 2). (a) Multi-lag trajectory: lag +1 CHSH rate 0.752 (n=504, +0.199 above baseline 0.553), drops to 0.522 at lag +2 (within null), 0.560 at lag +3, 0.521 at lag +4. Per-lag null distribution (1000 random non-hazard tokens of matched count): ONLY lag +1 passes p99=0.653 (p_emp=0.0000); lag +2/+3/+4 within random distribution. Single-step decay, no sustained intervention. (b) Hazard-class specificity: class 30 post-CHSH 76.6% vs class 7 73.4%; spread 0.032; NOT class-specific. (c) Triplet pattern hazard→CHSH→?: 50/50 next CHSH/QO; asymmetry -0.084; NO continuation. (d) Folio-level consistency: 94.9% of 59 folios with ≥3 events show CHSH > baseline. (e) Within-folio shuffle null (1000 perms, expert-advisor required): global rate 0.752 vs p99 0.625 p_emp=0.0000; folio fraction 94.9% vs p99 84.8% p_emp=0.0000; mean folio rate 0.775 vs p99 0.645 p_emp=0.0000. All three substrate measures pass at p<0.001. Effect is real, substrate-level, single-step instruction-grammar bigram. Multi-step thermal-kinetic-architecture reading NOT supported. Mechanism interpretation underdetermined; remains Tier 4 SPECULATIVE per feedback_mechanism_cycle_procedural_ceiling.md. Refines C645's lag-1 specificity; does NOT conflict with C645.	2	post_hazard_recovery, single_step_bigram, substrate_level, folio_shuffle_null_pass, multi_lag_trajectory, class_agnostic, no_continuation, sharpening_of_C645, expert_consultation_split_registration, C645, C109, C1487, C521	n_hazards_total=954. n_with_next_en=504. base_chsh_rate=0.5529. lag1_chsh=0.7520. lag2_chsh=0.5216. lag3_chsh=0.5602. lag4_chsh=0.5213. lag1_null_p99=0.6530. lag1_p_emp=0.0000. class_7_chsh=0.7342. class_30_chsh=0.7660. class_spread=0.0319. triplet_chsh_then_chsh=0.5000. triplet_qo_then_chsh=0.5844. triplet_asymmetry=-0.0844. n_folios_data=59. frac_folios_above_baseline=0.9492. mean_across_folio_chsh=0.7751. within_folio_shuffle_null_global_p_emp=0.0000. axes_passing=2_of_5. R1_class_spec=FAIL. R2_multi_lag=PASS_single_step. R3_triplet=FAIL. R4_pre_hazard_buildup=FAIL_see_C2046. R5_folio_consistency=PASS_strong. mechanism_interp_tier=4_speculative.
C2046	No Pre-Hazard QO/Heating Buildup (Hazards Not Precipitated by Heating Excursion). PHASE_714 R4 negative measurement. For each hazard token (n=954 in Currier B), measure QO/CHSH distribution at lag -1/-2/-3 EN-positions BEFORE the hazard. Thermal-overshoot prediction: elevated QO buildup. Observed: QO rate at lag -1 = 42.3% (n=645), lag -2 = 41.2% (n=434), lag -3 = 43.0% (n=272). All BELOW baseline QO rate 44.7% by -0.024, -0.035, -0.017. No heating buildup before hazards; CHSH (cooling) mildly elevated in pre-hazard contexts. Crazy-expert reframe (Tier 4 SPECULATIVE only): hazards occur during sustained CHSH-dominant contexts (stabilization failure rather than thermal overshoot). System already in CHSH/cooling mode when hazard triggers; failure is INSIDE absorbing well (e-stabilizer capacity), not from heating excursion. Falsifies specific "hazards arise from accumulated heating" mechanism inference. C109's 5 hazard categories include ENERGY_OVERSHOOT (1 of 5) but observable grammar signature is not consistent with overshoot dominance. Hazards more compatible with composition/timing/phase events than thermal overshoot. F-B-008 (two-channel thermal) and F-B-009 (overshoot-correct cycling) flagged for review — multi-step overshoot-cycling mechanism unsupported. Scope caveats: (1) negative measurement only, does NOT prove thermal interpretation wrong overall, only that "heating buildup → overshoot → cooling recovery" mechanism inference is not supported. (2) 5 hazard classes per C109 NOT individually mapped to physical categories at token level. (3) "No QO buildup" does not exclude other excitation modes.	2	pre_hazard_signature, negative_measurement, no_QO_buildup, falsifies_thermal_overshoot_mechanism, stabilization_failure_candidate_tier4, multi_step_thermal_protocol_falsified, C645, C2045, C109, C105, C521, F-B-008, F-B-009	n_hazards=954. lag_minus_1_qo_rate=0.4233. lag_minus_2_qo_rate=0.4124. lag_minus_3_qo_rate=0.4301. baseline_qo_rate=0.4471. lag_minus_1_qo_above_baseline=-0.0238. lag_minus_2_qo_above_baseline=-0.0347. lag_minus_3_qo_above_baseline=-0.0170. n_lag_minus_1=645. n_lag_minus_2=434. n_lag_minus_3=272. thermal_overshoot_mechanism_falsified=yes. stabilization_failure_tier4=crazy_expert_candidate. F-B-008_flag_for_review=yes. F-B-009_flag_for_review=yes. multi_step_thermal_protocol_unsupported=yes. negative_measurement_scope_only=yes.
C2047	Substrate Has Heterogeneous Directional Depth (5-Anchor Cross-Refinement). PHASE_715 applied PHASE_714 methodology to 5 directional anchors. A0 hazard→CHSH (C645, n=956): lag+1 obs 0.221 vs null p99 0.219, lag+2 fails — SINGLE-STEP. A1a h-TERM→MIDDLE[0]=p (C1212, n=1316): lag+1 obs 0.022 vs p99 0.015, lag+2 obs 0.018 PASSES — MULTI-STEP (borderline magnitude). A1b r-TERM→MIDDLE[0]=a (C1212, n=1958): lag+1 obs 0.320 vs p99 0.145, lag+2 obs 0.187 PASSES p99 0.164, lag+3 barely passes — MULTI-STEP (primary evidence). A2 qo-k→ok-e (C1314, n=2545): lag+1 obs 0.042 vs p99 0.037, lag+2 fails — SINGLE-STEP. A3 ar→al (C2041, n=685): lag+1 obs 0.069 vs p99 0.041, lag+2 fails — SINGLE-STEP. All 5 pass within-folio shuffle null at p<0.001 at lag+1; substrate-level not folio-composition. Cross-anchor verdict: 3 single-step + 2 multi-step = HETEROGENEOUS DEPTH. Substrate is NOT uniformly bigram-rule. C2045's "substrate-level single-step" framing narrowed — applies only to hazard recovery. Methodology fix: A1a originally `head_atom='p'` but p is MOD atom not HEAD; corrected to `MIDDLE[0]='p'` first-character predicate. Scope caveats: A1a borderline-stable (A1b primary), no NL Latin floor check on heterogeneous-depth claim (optional strengthening), mechanism "two-tier grammar architecture" interpretation Tier 3-4 only.	2	cross_anchor_refinement, heterogeneous_depth, multi_step_substrate, single_step_substrate, within_folio_shuffle_null_pass, methodology_fix_documented, C2045_scope_narrowed, C645, C1212, C1314, C2041, C1019, C1379	n_anchors=5. anchors_single_step=3. anchors_multi_step=2. A0_lag1_obs=0.2208. A0_pattern=single_step. A1a_lag1_obs=0.0216. A1a_pattern=multi_step_borderline. A1b_lag1_obs=0.3204. A1b_lag2_obs=0.1872. A1b_pattern=multi_step_primary. A2_lag1_obs=0.0420. A2_pattern=single_step. A3_lag1_obs=0.0686. A3_pattern=single_step. all_pass_folio_shuffle_p_001=yes. methodology_fix_A1a=head_to_middle0_predicate. C2045_scope_narrowing_required=yes. mechanism_two_tier_grammar_tier=3_4_speculative.
C2048	C1212-Type Cross-Token TERM→MIDDLE[0] Chaining Shows Multi-Step Substrate Dependency. PHASE_715 A1a + A1b results. C1212's z=20.3 cross-token sequential signal previously characterized at bigram-level; PHASE_715 extends to multi-step. (a) r-TERM→MIDDLE[0]=a (A1b primary, n=1958): baseline 0.133, lag+1 0.320 (2.41x), lag+2 0.187 (1.41x, passes null p99 0.164), lag+3 0.181 (barely passes p99 0.176), lag+4 baseline-level. Within-folio shuffle null observed 0.320 vs p99 0.175 p_emp=0.000. (b) h-TERM→MIDDLE[0]=p (A1a replication, n=1316): baseline 0.009, lag+1 0.022 (2.45x), lag+2 0.018 (2.00x, passes p99 0.015), lag+3 0.018. Within-folio shuffle null observed 0.022 vs p99 0.015 p_emp=0.000. A1a magnitude caveat: absolute rates small (~0.02), null p99 close (~0.015), borderline-stability — A1b is cleaner separation, A1a confirms independently but absolute effect in noise-floor territory. Layer distinction: operates at atom-character composition layer (C1394 HEAD+MOD*+TERM atom positions) INDEPENDENT of C109 class-layer forbidden transitions. Predicate semantics: target = `MIDDLE[0] == X` first-character match regardless of role classification (HEAD/MOD/TERM). Documented for audit clarity per expert-advisor scrutiny. Refines C1212: z=20.3 sequential signal has multi-step depth extending 2-3 positions beyond immediate adjacency. Mechanism "compositional carry-over" / "instruction-packet 2-3-gram" Tier 3 framing only. Mensural floor not applicable (TERM/MIDDLE grammar Voynich-specific). Possible PHASE_716 follow-up (crazy-expert): test whether multi-step chaining is mechanism behind C1727 line-ordering smoothness z=-6.05.	2	C1212_refinement, cross_token_chaining, multi_step_dependency, atom_character_layer, MIDDLE_first_position, A1b_primary_A1a_replication, layer_distinct_from_C109, predicate_semantics_documented, mensural_skip_justified, C1212, C1394, C109, C1019, C1727	predicate_form=MIDDLE_first_character_match_role_independent. n_predicate_pairs_tested=2. A1b_baseline=0.1333. A1b_lag1=0.3204. A1b_lag2=0.1872. A1b_lag1_ratio=2.41x. A1b_lag2_ratio=1.41x. A1b_within_folio_shuffle_p_emp=0.0000. A1a_baseline=0.0088. A1a_lag1=0.0216. A1a_lag2=0.0179. A1a_lag1_ratio=2.45x. A1a_lag2_ratio=2.00x. A1a_magnitude_in_noise_floor=yes. extends_C1212_z_20_3=yes_to_multi_step. layer=atom_character_not_class. mechanism_compositional_carry_over_tier=3.
C2049	Cross-Line C1212 Chaining is NOT the Mechanism for C1727 Line-Ordering Smoothness. PHASE_716 main test (2026-05-20). Crazy-expert PHASE_715 follow-up hypothesis: multi-step C1212 chaining (TERM→MIDDLE[0] extending lag+2/+3 per C2048) propagates across line boundaries and produces line-ordering smoothness. Pre-registered discriminating test: if C1212 IS mechanism, excluding first 3 tokens of each line should COLLAPSE smoothness toward z=0 (≥80% magnitude collapse). Result: OPPOSITE direction. Excluding first 3 tokens INTENSIFIES smoothness +21.2% (z=-3.79→-4.59); excluding last 3 tokens also intensifies +8.6%; excluding both intensifies +23.7%. Line-boundary tokens add NOISE not signal. Cross-line C1212 propagation FALSIFIED. C1212/C2048 multi-step is line-INTERNAL not line-spanning. Consistent with C1429 cross-line independence MI=0.032 bits, C1470 cross-line hazard folio-mediated only, C964 boundary-constrained free-interior. Crazy-expert accepted: "This isn't ambiguous — it's anti-signal." Scope: folio-segmented reproduction z=-3.81 vs original C1727 paragraph-segmented z=-6.05; direction holds despite magnitude attenuation. Methodology note: paragraph-mean residualization mathematically invalid (constant shift identity).	2	mechanism_falsification, C1212_NOT_mechanism, line_spanning_chaining_rejected, pre_registered_discriminator, boundary_tokens_add_noise, line_internal_not_line_spanning, C1212, C2048, C1727, C1429, C1470, C964	n_paragraphs=82. baseline_z=-3.81. skip_first_3_z=-4.591. magnitude_change_first_3=+21.2pct_INTENSIFIES. skip_last_3_z=-4.115. magnitude_change_last_3=+8.6pct. skip_both_3_z=-4.684. magnitude_change_both=+23.7pct. pre_registered_threshold_collapse=80pct. observed_direction=INTENSIFICATION. crazy_expert_accepted=yes. scope=folio_segmented.
C2050	Mode A/B Coherence is NOT the Mechanism for C1727 Line-Ordering Smoothness. PHASE_716 mode-aware extension (user-suggested hypothesis). Paragraphs are mode-coherent per C1423 (2.89% CMI) — does mode-coherence drive C1727 smoothness? Three tests: (a) Within-mode pair distances: A-A mean d²=11.27, B-B=17.27; cross-mode A-B mean d²=10.69, B-A=11.76. Ratio cross/within = 0.80 — cross-mode pairs SMALLER than within-mode, OPPOSITE the mode-coherence prediction. (b) Mode-residualization 0% (mathematically invalid — constant shift identity; not informative). (c) Mode-transition rate 40.4% — paragraphs not strongly mode-locked. Mode coherence FALSIFIED. Mode is downstream of HEAD/TERM per C1341 (80% predicted by composition alone); doesn't carry independent sequential structure. C2051 below identifies actual signal in HEAD+TERM joint coherence. Mode partition: C1410 (Mode A = {d,e,ee,h,y}, Mode B = {a,i,ii,l,m,n,o,r,s}).	2	mode_NOT_mechanism, C1410_partition_test, cross_mode_NOT_larger_than_within, mode_transition_rate_40pct, mode_downstream_of_HEAD_TERM, falsifies_user_hypothesis, C1410, C1423, C1341, C1727, C2049	within_mode_pair_count=1380. cross_mode_pair_count=935. within_mode_mean_d2=14.07. cross_mode_mean_d2=11.23. ratio_cross_to_within=0.80. mode_transition_rate=0.404. AA_mean_d2=11.27. BB_mean_d2=17.27. AB_mean_d2=10.69. BA_mean_d2=11.76. mode_residualization_INVALID_constant_shift=yes. C1341_mode_downstream_80pct=yes.
C2051	HEAD+TERM JOINT Coherence is the Localizable Signal for Line-Ordering Smoothness (Folio-Segmented). PHASE_716 comprehensive search + expert-advisor blocking controls. Of 12 schemes tested, signal concentrated in HEAD+TERM JOINT features: 13-dim subset z=-7.76 vs baseline z=-3.81. Individual HEAD-only (6 dim) z=-6.13 and TERM-only (7 dim) z=-6.31 are weaker than joint. Mode and length features DILUTE signal (no_mode z=-3.69, no_length z=-4.75 INTENSIFIES when length removed). Critical artifact control (expert-advisor required): 50 random 13-feature subsets give mean z=-3.88 std 0.29; HEAD+TERM rank 2pct of 51 — REAL specific signal not dimensionality artifact. 50 random 6-feature subsets give mean z=-4.55; HEAD-only rank 13.7pct — MARGINAL. 50 random 7-feature subsets give mean z=-4.46; TERM-only rank 17.6pct — MARGINAL. JOINT coherence is specific; individual HEAD or TERM signals only marginal above dimensionality-matched random. Within-paragraph sequential variation in HEAD+TERM distributions jointly. Mechanism interpretation (recipe progression / topic shift / narrative structure) remains Tier 3-4 SPECULATIVE per feedback_mechanism_cycle_procedural_ceiling.md. Scope: folio-segmented (z=-3.81) vs original C1727 paragraph-segmented (z=-6.05); direction consistent magnitude attenuated. Baseline z stable across 3 seeds × 3000 shuffles (std 0.052). Companion to C2049 (C1212 falsified) + C2050 (mode falsified).	2	mechanism_narrowing, HEAD_TERM_joint_coherence, dimensionality_artifact_control_passed, baseline_robustness_passes, mode_and_length_dilute, folio_segmented_scope, individual_HEAD_TERM_marginal_only_joint_specific, mechanism_tier_3, C1727, C2049, C2050, C1379, C1003, C1394	baseline_z=-3.811. baseline_std_across_seeds=0.052. n_seeds=3. n_shuffles_per_seed=3000. head_term_joint_13dim_z=-7.763. random_13_subset_mean_z=-3.878. head_term_rank=2pct_of_51_REAL. head_only_6dim_z=-6.130. random_6_subset_mean_z=-4.548. head_only_rank=13.7pct_MARGINAL. term_only_7dim_z=-6.314. random_7_subset_mean_z=-4.463. term_only_rank=17.6pct_MARGINAL. mode_only_z=-2.345. length_only_z=-3.657. no_length_z=-4.753_INTENSIFIES. paragraph_mean_residualization_INVALID. scope=folio_segmented_not_paragraph. baseline_reproduction_discrepancy=1.6x. mechanism_interp_tier=3_4_speculative. n_paragraphs=82.
C2052	8D Matcher Theophilus Negative Control FAILS: Matcher is Generic at Text-Feature Level (Domain-Discrimination Falsified). PHASE_718 (2026-05-20). Pre-registered test locked 2026-05-14 per sources/theophilus/README.md, executed first time 2026-05-20 via existing script _theophilus_negative_control.py. Theophilus De Diversis Artibus (~1120 CE, metalwork/glass/pigments — NOT alchemy) tested as negative control for 8D matcher producing C1971 + C1882-C1956 family. Pre-registered criteria: C1 4/30 AMBIGUOUS, C2 0.878 PASS, C3 p=0.0000 FAIL, C4 53.3pct FAIL. 2 FAIL + 1 PASS + 1 AMBIGUOUS. Script verdict: FAIL — matcher generic, demote C1882-C1956 to structural-similarity. 16/30 Theophilus matches land on same Voynich folios as Pseudo-Lull match list. Permutation p=0.0000. **CRITICAL SCOPE CLARIFICATION: What this refutes is the 8D MATCHER'S domain-discriminative power, NOT the distillation/thermal interpretation broadly.** The distillation reading rests on multiple INDEPENDENT lines of evidence: PWRE-1 structural narrowing (SPECIFICALLY EXCLUDES Theophilus-type irreversible-transformation metalwork from controller's compatible physics class, leaving circulatory thermal conditioning / volatile extraction / circulatory reflux as the surviving candidates); PHYS kernel dynamics (k/h excitation → e stability, rapid recovery); C1314 qo-k/ok-e thermal cycling within-line bigram; C645+C2045 hazard-recovery directional; C2042 atom-monocategorical operational signature; substrate quintet non-NL discriminators. NONE of these are touched by the matcher test. PWRE+matcher together imply the matcher's text features aren't physics-sensitive — they cluster by surface text properties regardless of underlying physics. The matcher's genericity REVEALS this measurement limitation; it does NOT refute the independent physics narrowing. Both experts consulted, converged on per-constraint triage (NOT blanket demotion): content claims → DEMOTE Tier 3, structural claims → SURVIVE Tier 2. Tier 0, C2032, C2042, C1314, PHYS dynamics, PWRE narrowing, C645+C2045 all UNAFFECTED. The distillation/thermal-circulatory interpretation broadly stands on independent evidence. What scope-refines is the 8D-matcher-based content-correspondence claims (e.g., "Voynich folio X has Pseudo-Lull chapter Y content") — those need triage. Pattern (8D-matcher-specific): 4 failed mechanism interpretations this session (PHASE_711 parametric, PHASE_716 line-spanning + mode coherence, PHASE_718 matcher domain-specificity) — internal-only domain-claim interpretations using project framework vocabulary reliably die at proper discriminating tests. Independent-evidence interpretations (PWRE, substrate quintet, atom signature, PHYS) weren't tested by this session's discriminators and survive. Per-constraint audit of C1971+C1882-C1956 queued as PHASE_719 candidate. Expert estimate: ~15-25 of ~75 constraints need demotion; most are structural measurements that survive.	2	negative_control_FAIL, matcher_text_feature_genericity_confirmed, matcher_domain_specificity_falsified, structural_attraction_survives, distillation_interpretation_broadly_NOT_refuted, PWRE_independent_narrowing_unaffected, PHYS_kernel_dynamics_unaffected, C1314_thermal_cycling_unaffected, C645_C2045_hazard_recovery_unaffected, pre_registered_test, per_constraint_audit_queued, Tier_0_unaffected, C2042_unaffected, C2032_unaffected, scope_refinement_matcher_content_correspondence_only, C1971, C171	n_theophilus_chapters=30. n_regime_1_folios=32. mean_distance=2.7165. mean_ratio=0.878. n_confident_matches=4. permutation_p=0.0000. section_b_concentration_pct=53.3. n_theophilus_on_PL_folios=16_of_30. C3_observed=0.0000_FAIL. C4_observed=53.3pct_FAIL. script_verdict=FAIL_matcher_generic. pre_registration_date=2026_05_14. first_run_date=2026_05_20. tier_0_unaffected=yes. C2032_unaffected=yes. C2042_unaffected=yes. C1314_unaffected=yes. PHYS_kernel_dynamics_unaffected=yes. C645_C2045_unaffected=yes. PWRE_narrowing_unaffected=yes. C171_semantic_ceiling_reconfirmed_at_matcher_level=yes. per_constraint_audit_queued=PHASE_719. blanket_demotion_avoided=yes. triage_criterion=content_demote_structure_survive. session_failed_mechanism_count=4_all_at_internal_matcher_or_pattern_layer. matcher_8d_genericity_at_text_feature_level=confirmed. matcher_text_features_not_physics_sensitive=yes. PWRE_excludes_theophilus_metalwork_irreversible=yes. matcher_genericity_reveals_measurement_limitation_not_refutation=yes. distillation_thermal_circulatory_interpretation_broadly_refuted=NO. independent_evidence_interpretations_survive=yes. scope_refinement_only_8D_matcher_content_correspondence_claims=yes.
C2053	C2032 NL Latin Baseline Range Expanded From N=2 To N=4 — Voynich Discrimination Preserved But Narrower. PHASE_720 v2 calibrated (15-80 word length filter, matches canonical C2032 via _c2031_codicillus_cross_validation.py). Calibration verification: Codicillus reproduces r21=-0.229 (canonical -0.22 within rounding). New corpora tested: Rupescissa (distillation/quintessence, 279 paras, 11293 words) r21=+0.226 monotonic — OPPOSITE sign from Codicillus despite same domain class; Theophilus body (metalwork, 144 paras, 6364 words) r21=+0.495 — most positive of any tested Latin, monotonic. Combined with documented Mesue -0.17: NL Latin r21 spans -0.23 to +0.50 across N=4 corpora, substantially wider than C2032's original N=2 baseline range -0.17 to -0.22 (Codicillus + Mesue only, both compact-formulaic-recipe Latin). Voynich Section B r21=-0.66 remains strongest period-2; discrimination magnitude shrinks from ~3x (original framing) to ~2.88x (calibrated) to nearest NL when broader Latin range considered. Direction preserved. Scope refinement to C2032: "NL Latin range -0.17 to -0.22" characterization was N=2 generalization; needs footnoting with expanded N=4 data. C2032 core finding (Voynich non-NL at -0.66) preserved. PHASE_720 v1 calibration gap (r21=-0.007 at 20-50 filter) traced to length-filter parameter mismatch in PHASE_721 investigation. Expert convergence: register measurement only, defer register-vs-domain interpretation per feedback_framework_as_null.md (N=4 + post-hoc fit). Crazy-expert proposed intra-corpus stratification of Rupescissa as follow-up (PHASE_722 candidate, ~3-hour test). Refines C2032; does not retract. Tier 0, C2042 atom-monocategorical, PWRE-1 narrowing, PHYS dynamics, C1314 cycling, C645+C2045 hazard recovery all UNAFFECTED — none depend on C2032 stem-class measurement.	2	C2032_scope_refinement, NL_baseline_expanded_N2_to_N4, calibrated_methodology, Codicillus_reproduces_canonical, Rupescissa_opposite_sign_from_Codicillus, Theophilus_most_positive, Voynich_strongest_period_2, register_vs_domain_deferred_per_framework_as_null, measurement_only, C2032, C2031	calibrated_length_filter=15_80_words. codicillus_r21=-0.229. codicillus_n_paragraphs=148. mesue_r21_documented=-0.17. rupescissa_r21=+0.226. theophilus_r21=+0.495. voynich_section_b_r21=-0.66. nl_latin_range_n4=-0.23_to_+0.50. nl_latin_range_original_n2=-0.17_to_-0.22. discrimination_magnitude_to_nearest_nl=2.88x. v1_calibration_gap=length_filter_20_50_vs_canonical_15_80. v2_codicillus_reproduces_canonical=yes. interpretation_deferred=register_vs_domain. tier_2_measurement_only=yes. C2032_core_voynich_non_nl=preserved. PWRE_narrowing_unaffected=yes. C2042_unaffected=yes. Tier_0_unaffected=yes. queued_PHASE_722_intra_corpus_rupescissa_stratification=yes.
C2055	Voynich Currier B Is Character-Markov At 5-Gram Order (Engineered Substrate Fourth Axis). PHASE_729 (2026-05-26). A character n-gram trained on Currier B reproduces every surface statistic within sampling noise at order >=4: TTR 0.231 vs real 0.212; hapax-types 64.5% vs 67.2%; hapax-tokens 14.9% vs 14.2%; Zipf slope -0.913 vs -0.930; top-100 coverage 42.6% vs 47.5%; cell-fill at 4-7 char window 70.4% vs 71.0%; distinct 2-char starts 141 vs 148. The 3-gram trained on same data BEATS the 4.8M-parameter PHASE_691 transformer LM on bpc: 1.95 vs 2.79, ratio 0.70 — character-level structure beyond trigram DEGRADES prediction. Order >=5 is the saturation point. PHASE_691's existing markov_showdown.py result had been mis-interpreted as "shallow structure" when the n-gram actually decisively wins. Consequences: (a) historical "Voynich is too statistically weird to be NL" framing inverts to "Voynich is too statistically REGULAR to be NL — lacks long-range structure NL requires". (b) Surface-statistics arguments for "designed slot grammar" are now floor-level — any Markov chain produces them. (c) Combined with C2032 (cross-NL discriminator surviving Markov null at synth +0.22), C2015 (compression), C2022 (anti-NL char distribution), this is the FOURTH AXIS of the engineered-substrate stack. (d) Establishes 5-gram null as methodological discipline for future constraints. NL-character-level falsification strengthened. Architectural-tier claims that survived this null (C2032, correction-lane family C2056, atom monocategorical C2042) are sharpened by being above-Markov. Methodology memory feedback_5gram_markov_null_for_surface_patterns.md registered.	2	character_markov_5gram_match, surface_statistics_floor_level, transformer_loses_to_trigram, engineered_substrate_fourth_axis, NL_falsification_strengthened, methodological_discipline_for_future_constraints, B, PHASE_729	ttr_real=0.212. ttr_synth_5gram=0.231. hapax_type_real=67.2pct. hapax_type_synth=64.5pct. zipf_real=-0.930. zipf_synth=-0.913. cell_fill_47_real=71.0pct. cell_fill_47_synth=70.4pct. transformer_bpc=2.789. ngram_3_bpc=1.950. ngram_4_bpc=1.967. ngram_5_bpc=2.084. ngram_to_transformer_ratio=0.699. order_saturation=5. fourth_substrate_axis=yes. methodology_memory=feedback_5gram_markov_null_for_surface_patterns.

C2056	Post-Heat Polymorphic Correction-Lane Family (Architectural Unit Subsuming C1314). PHASE_729 (2026-05-26). After qo-k (heat addition) tokens, the immediately-following token shows above-Markov enrichment across multiple specific lanes — not a single bigram preference. Five lanes tested against 5-gram null trained on Currier B; all 5 show 17-30 percentage points of residual signal beyond local-character-statistics floor. Lane results (real % above shuffle null; synthetic % above shuffle null; residual = real - synth): (a) qo-k -> ok broad vessel correction: +35.1% / +5.5% / RESIDUAL +29.6 pp; (b) qo-k -> ot transfer: +23.4% / -4.4% / RESIDUAL +27.8 pp; (c) qo-k -> ch active monitor: +36.3% / +12.2% / RESIDUAL +24.1 pp; (d) qo-k -> ok-e cool-stabilize narrow C1314: +41.3% / +18.1% / RESIDUAL +23.3 pp; (e) qo-k -> sh passive monitor: +4.7% / -12.3% / RESIDUAL +17.0 pp. Broader qo -> ch (any qo prefix): residual +25.0 pp. Interpretive shift: C1314 narrow form (qo-k -> ok-e registered Tier 2 2026-02-25) measured ONE BRANCH of a much wider polymorphic correction-window pattern. The architectural unit is not the individual bigram but the CORRECTION WINDOW following thermal initiation: real text routes through any of {ok, ot, ch, sh, ok-e} with consistent above-Markov probability while a character 5-gram routes uniformly. Maps directly to thermal-process control: heat -> {vessel adjust, transfer, active test, passive watch, cool stabilize}. Supersedes C1314 narrow form; references C1313, C645+C2045 (NOW DEMOTED, see disposition below), C929. Predecessor constraints preserved as historical scope. CRUCIAL DISTINCTION from C1727 + C645+C2045 demotion this same phase: the 17-30 pp residuals here represent GENUINE above-Markov structure; C1727 (residual ~0) and C645+C2045 (residual +2.3 pp) are Markov-reproducible. The correction-lane family is what real structural signal looks like vs surface-statistic floor. Strongest single architectural result of PHASE_729 session.	2	correction_lane_family, post_heat_polymorphic_response, supersedes_C1314_narrow_form, five_lanes_17_to_30_pp_residual, architectural_unit_not_individual_bigram, thermal_control_loop_signature, survives_5gram_null, distinguishes_from_C1727_C645_demotion, B, PHASE_729	qo_k_to_ok_real=35.1pct. qo_k_to_ok_residual_pp=29.6. qo_k_to_ot_real=23.4pct. qo_k_to_ot_residual_pp=27.8. qo_k_to_ch_real=36.3pct. qo_k_to_ch_residual_pp=24.1. qo_k_to_ok_e_real=41.3pct. qo_k_to_ok_e_residual_pp=23.3. qo_k_to_sh_real=4.7pct. qo_k_to_sh_residual_pp=17.0. broad_qo_to_ch_residual_pp=25.0. n_lanes_strong_residual=5. supersedes=C1314_narrow_form. references=C1313_C929. distinguishes_from_C1727_residual_zero=yes. distinguishes_from_C645_C2045_residual_2_3pp=yes.

PHASE_729 DISPOSITIONS (2026-05-26): C1727 DEMOTED Tier 2 -> Tier 3 (line-ordering smoothness real z=-3.83 vs synth z=-3.71, Markov-trivial; cascades to C2049/C2050/C2051). C645+C2045 SCOPE SHARPENED — measurement preserved (post-hazard CHSH bias +19.6 pp), mechanism interpretation "thermal damage control" retracts to Tier 4 SPECULATIVE; despite passing within-folio shuffle p<0.001 fails 5-gram null at residual +2.3 pp. C1314 MARKED SUPERSEDED by C2056. C2052 REFINED — synthetic folio profiles 100% in real Mahalanobis cloud with half variance. f77r catalog entry annotated p_emp=0.000 validated. f39r catalog entry annotated p_emp=0.002 validated (non-distillation pearl-making — broadens framework). f103v / f115r catalog entries flagged FAILED 5-gram null (p=0.227, 0.225, tautological predictions). f43v marginal p=0.011. Failure-mode taxonomy Pattern 8 added (structural finding reproducible by appropriate-order local-statistics null).

C2057	Currier A RI Linker Topology Is Structural-Only — No Atom-Level Semantic Content. PHASE_730 (2026-05-28). Extending C835 (4 linkers, 12 edges with non-random topology vs degree-preserving null), an atom-specificity battery on linker MIDDLEs returns 0/5 PASS: linker-bearing tokens do not concentrate any specific atom signature relative to controls. Linker topology H1 (non-random clustering) and H5 (degree-preserving null) PASS. Linker content H2/H3/H4 all FAIL. Atom-specificity: 0/5 subtests pass. Linkers mark structural connections without carrying semantic content. Consistent with C171 (semantic ceiling) and C233 (LINE_ATOMIC) — content-empty linkers don't violate non-sequentiality. Tier 2 measurement; the topology fact and content-empty fact form an asymmetric pattern that survives expert review (deflationary, not framework-fitting).	2	linker_topology_real, linker_content_empty, A_RI, atom_specificity_zero_of_five, refines_C835, asymmetric_pass_fail_pattern_robust, PHASE_730	topology_tests_passed=2_of_2_H1_H5. content_tests_failed=3_of_3_H2_H3_H4. atom_specificity_tests_passed=0_of_5. n_linkers=4. n_edges=12. tier=2. predecessor=C835.

C2058	Falsification — Currier A o-HEAD "Arrange" Rate Does NOT Track Plant-Illustration Morphological Complexity. PHASE_730 (2026-05-28). Pre-registered, locked before running: if o-HEAD vocabulary encodes botanical spatial structure, herbal folios with more-complex plant illustrations should have higher o-HEAD rate. N=29 Currier A herbal folios with PIAA blind morphological "Key Features" descriptions; complexity proxy = count of distinct plant-structure terms (leaf, root, flower, stem, spike, branch, head, bulb, pod, frond, rosette, palmate, lobed, etc.). Raw Spearman rho(complexity, o-rate) = +0.031, p=0.87. Token-count confound: rho(tokens, o-rate)=+0.41, p=0.027. PARTIAL CORRELATION CONTROLLING FOR TOKEN COUNT: rho = -0.057, p=0.77. Falsifies "o-HEAD arrangement vocabulary describes plant visual structure" via this proxy. SCOPE OF FALSIFICATION: spatial-complexity-via-morphological-tag-count proxy. Does NOT falsify botanical-category-coded, use-coded, or any non-spatial interpretation. Extends manuscript-wide pattern (C138, C140) — Voynich text does not describe its illustrations; the arrangement vocabulary is operational, not depictive. Methodological note: PPC plant-morphology classification originally consulted was Currier B (wrong system); error caught and corrected via PIAA (29 actual Currier A herbal folios) before locking result.	2	falsification, A_o_HEAD_not_botanical_proxy, scope_limited_to_spatial_complexity, partial_correlation_controlled, extends_C138_C140, PIAA_used_not_PPC, PHASE_730	n_folios=29. spearman_raw=+0.031. p_raw=0.87. token_confound_rho=+0.41. token_confound_p=0.027. partial_rho_controlling_tokens=-0.057. partial_p=0.77. proxy_used=PIAA_morphological_key_features_term_count. tier=2. falsification_scope=spatial_complexity_proxy_only.

C2059	Currier A Section P Recovers Thermal HEAD-Domain Profile (B-Like) Inside A. PHASE_730 (2026-05-28). Section-stratified HEAD distribution across Currier A: Section H (herbal) o=26.2%, e=10.9%, k=4.6%, a=5.8% — arrangement-dominant; Section P (pharma) o=21.1%, e=28.0% (thermal-recovery, B-like), k=8.1%, a=6.4%; Section T (text) o=20.6%, e=13.4%, k=8.8%, a=21.7% — yield+arrange co-dominant. Currier B baseline: e=40.4%, o=16.1%, k=19.0%, a=18.9% (thermal-dominant). The Section P thermal-recovery is not articulated by C1266 (which used atom-cluster framing); this finding sharpens C1266 at HEAD-domain resolution. INTERPRETIVE SCOPE: structural measurement only. Operational reading ("P is A's pharma-execution sub-context") is framework-echo-suspect and held to Tier 4 SPECULATIVE pending independent discriminating evidence. Sections diverge at HEAD level — A is NOT uniformly arrangement-dominant, P is structurally B-like in HEAD profile.	3	section_HEAD_domain_split_within_A, section_P_thermal_recovery, refines_C1266_at_HEAD_resolution, operational_interpretation_held_to_Tier_4, A_not_uniformly_arrangement, PHASE_730	section_H_o_head_pct=26.2. section_H_e_head_pct=10.9. section_P_o_head_pct=21.1. section_P_e_head_pct=28.0. section_T_o_head_pct=20.6. section_T_a_head_pct=21.7. currier_B_e_head_pct=40.4. currier_B_o_head_pct=16.1. tier=3. predecessor=C1266.

C2060	The C109 5-Class Hazard Taxonomy Was Imposed By Keyword-Matching, Not Discovered By Clustering. PHASE_732 (2026-05-28). Source phase18_failure_typology.py HARDCODES 5 distillation-failure-mode classes + keyword lists (lines 61-87); the 17 forbidden transitions are sorted by keyword substring-match (lines 392-411). NO clustering produced 5 — the only clustering in the phase 15-20 chain produced 1 cluster (phase15a internal_clusters=1); phase 16 had a different 12-mode scheme. C109's stated evidence "Cluster analysis reveals 5 natural groupings" is FALSE about its method (failure pattern #9: discovered-method claim for imposed-method result / phantom-clustering). Empirical atom-territory clustering of the 17 transitions (src/tgt HEAD+TERM): silhouette-optimal k=8 (0.479); k=3 (0.400) >= k=5 (0.372) — 5 NOT data-preferred; natural-vs-imposed ARI=0.42 (weak). Only PHASE_ORDERING (n=7, within-dist 0.154) is a tight gloss-coherent cluster (=C1529 sealed/y-terminal -> iteration/a-HEAD); CONTAINMENT_TIMING barely cohesive (0.218 vs random 0.224); RATE_MISMATCH+ENERGY_OVERSHOOT are singletons. GLOSS CHECK: ENERGY_OVERSHOOT ("scorching/heat") CONTRADICTED — sole member he->t has no k-HEAD heat atom (he=watch.cool per C1394; consistent with C1448 k-HEAD hazard immunity); RATE_MISMATCH/COMPOSITION_JUMP labels unsupported; PHASE_ORDERING supports only generic sequencing reading not "vapor lock". Real atom-territory structure independently+more-rigorously held by C1528-C1533. CAVEAT: imposed-partition cohesion z=-4.10 vs 2000 random is NEAR-CIRCULAR (keyword lists encode atom intuitions) and is NOT evidence for the 5-class count. DISPOSITION: C109 revised existence-only; 5-class taxonomy -> Tier 3-4 interpretive; C216 demoted Tier 2->3; C110/C111/C112 kept (taxonomy-independent or = the one real cluster); Tier 0 UNTOUCHED (frozen conclusion never depended on taxonomy). Public docs cleaned (GUIDE.md false "clustering is Tier 0" line struck; WHAT_WE_CLAIM "5 hazard classes" dropped; BCSC PROVENANCE_CORRECTION added).	2	imposed_taxonomy, false_method_claim, phantom_clustering_pattern_9, hazard_classes, k5_not_data_preferred, PHASE_ORDERING_only_real_cluster, ENERGY_OVERSHOOT_gloss_contradicted, atom_structure_held_by_C1528, B, PHASE_732	hardcoded_dict_lines=61_87. keyword_assignment_lines=392_411. clustering_in_chain=1_not_5. silhouette_optimal_k=8. k5_sil=0.372. k3_sil=0.400. ari_natural_vs_imposed=0.42. phase_ordering_within_dist=0.154. random_cohesion=0.224. cohesion_z=-4.10_NEAR_CIRCULAR. energy_overshoot_heat_atoms=0. tier0_untouched=yes.

C2061	Macro-State Eigenstructure of Currier B Class-Transition Operator Survives 5-gram Null (Vindicates C976-C978). PHASE_733 (2026-05-28). First 5-gram-null test of the class-layer macro-structure. The second eigenvalue lambda2 of the raw 49x49 class transition matrix (clean macro-state measure; bypasses C976 merge's hardcoded role/depletion constraints) is above-Markov: real lambda2=0.2063, 5-gram-synth 0.1194+/-0.017 sitting AT the within-line-shuffle floor 0.1176+/-0.009 (5-gram only 2pct of the way floor->real). Per-synth-own-shuffle symmetry control: real lambda2 excess +0.0873 vs synth +0.0517+/-0.014, z=+2.51, p=0.000 — real significantly exceeds synth under the SAME metric where scalar class-MI was REPRODUCED (p=0.21). 5-gram reproduces ~60pct of the lambda2 excess but the remaining ~40pct is above-Markov. Macro-automaton (C976-C978/C1010) passed the sharpest null it has faced. SCOPE: validates above-Markov macro-structure in the raw-49 operator, NOT a re-derivation of C978's 6-state 0.894 spectral gap (different operator). Partition-ARI through the C976 merge was CONFOUNDED (role/depletion constraints force ARI 0.67-0.80 for structureless nulls: random 0.669, shuffle 0.804, real 0.937, 5-gram 0.762) -> uninformative; raw-matrix lambda2 is the uncontaminated metric.	2	macro_eigenstructure_survives_5gram, lambda2_above_markov, vindicates_C976_C978, scoped_raw49_not_C978_gap, partition_ARI_confounded, B, PHASE_733	real_lambda2=0.2063. fivegram_lambda2=0.1194. shuffle_floor=0.1176. real_excess=0.0873. synth_excess=0.0517. excess_z=2.51. excess_p=0.000. partition_ari_real=0.937. partition_ari_random=0.669.

C2062	Three-Axis Decomposition of Currier B Class-Sequential Structure. PHASE_733 (2026-05-28). Class-layer sequential signal splits into three components with distinct 5-gram-null verdicts: (a) LOCAL CONTROL BIGRAMS (qo->ch/sh etc.) REAL above-Markov (PHASE_731 C549 z=5.79, C562 z=10.25); (b) MACRO-STATE EIGENSTRUCTURE (lambda2 of 49-class operator) REAL above-Markov (C2061 p=0.000); (c) AGGREGATE SCALAR FIRST-ORDER CLASS-MI (C2023) the floor-dominated MIDDLE layer, morphology-reproducible (5-gram per-synth p=0.21). A character 5-gram reproduces the scalar class-MI (high-mass-dominated lumped functional, dominated by local bigrams + morphology-derivable bulk) but NOT the macro-eigenstructure (global community-structure functional). Genuine grammar lives in local bigrams + macro-eigenstructure; the scalar aggregate is the weak layer.	2	three_axis_decomposition, local_bigrams_real, macro_eigenstructure_real, scalar_MI_morphology_shadow, B, PHASE_733	local_survivors=C549_C562. macro=C2061_p0.000. scalar_MI_5gram_p=0.21.

C2065	Currier B Macro-Eigenstructure Slow Mode Is DISTRIBUTED, Not Localized in the AXM Attractor. PHASE_736 (2026-05-29). The above-Markov macro-eigenstructure (C2061 λ2, raw-49) is spread across the class space, NOT in the AXM attractor self-loop. Submatrix-λ2: full 0.236, AXM-block-only 0.222, non-AXM lanes 0.205 (comparable, not attractor-concentrated). 2nd-eigenvector LOADING falsification: AXM-block loading 0.642 ~= class-fraction 0.65 (proportional, not concentrated); participation ratio 28.8/49; top-5 share 0.299; top loaders MIX AXM (22,21,2,8,41) + lane (7,23,9) classes -> SPREAD, not block-boundary-aligned. Survived falsification (a concentrated within-AXM gradient would have collapsed the claim + predicted high spectral ARI). Mechanistically GROUNDS C1010 non-spectral 6-state partition (ARI=0.059): role/depletion partition can't be spectrally recovered because slow mode doesn't align with blocks. Companion to PHASE_736 NON-FINDING that the AXM self-transition RATE is composition (C2062 scalar-vs-eigenstructure recurring at block level).	2	macro_slow_mode_distributed, not_in_attractor, participation_ratio_28.8, loading_class_proportional, grounds_C1010_nonspectral, falsification_survived, B, PHASE_736	lam2_full=0.2359. lam2_axm=0.2224. lam2_lanes=0.2047. axm_loading=0.642. class_fraction=0.65. participation_ratio=28.8.
C2066	Char-5-gram Null Has a Length-Confounded WINDOW-BLINDNESS — the Wrong Instrument for Token-Adjacency/Prefix-Routing Claims. PHASE_737/738 (2026-05-29). A char-n-gram conditions only on a fixed-width char window at the token boundary; a LONG source token's routing-relevant prefix (qo, daiin) falls OUTSIDE it, so the null cannot regenerate the token at corpus rate and transitions out of it survive as a source-ungeneratability ARTIFACT, NOT routing. CALIBRATION (PHASE_737): daiin->ch/sh survives per-synth-own-shuffle 5-gram (z=4.05/3.65) but 0/6 SHORT high-CHSH sources survive the SAME null (qol/sol/sor/dol/y/ol; daiin-ref survives, ol-ref demotes p=0.39) -> verdict FLIPS with source-token length = windowing signature. SENTINEL-INJECTION FIX FAILS (PHASE_738): a suffix-appended prefix-identity sentinel is ungeneratable from prefix-blind suffix context — fidelity audit 28.1pct correct-emission long-qo vs 99.6pct short -> test biased toward SURVIVE, uninformative. Char-Markov EXHAUSTED for long-token prefix-routing (low-order=window-blind, suffix-sentinel=ungeneratable, high-order=overfits). NON-REHABILITATION CLAUSE (load-bearing): window-blindness invalidates the 5-gram only as a DISCONFIRMING instrument — ZERO positive evidence. C557/C561/C816/C600/C817/C819 STAY demoted (short/generatable tokens — or, aiin, ol — where the 5-gram is valid); C2064/daiin stays ambiguous (C600/C817 NOT rehabilitated). NARROWS C2055 (does NOT contradict): 5-gram still correct for surface/positional/transition-rate claims; window-blind only for token-adjacency whose routing feature is out-of-window. Correct null for token-adjacency = within-line token-shuffle (re-grounded C549 + C2056 lanes). Diagnostic: a verdict flipping with source-token length is windowing — calibrate source-token emission fidelity before interpreting survival. Discharged C2064's pre-registered short-source discriminating test. COMPOSITION-PASS != ABOVE-MARKOV: token-shuffle proves above-composition only; do not upgrade the label.	2	window_blindness, length_confounded_sensitivity, source_token_fidelity_gradient, non_rehabilitation_clause, narrows_C2055, correct_null_is_token_shuffle, discharges_C2064_pretest, sentinel_ungeneratable, composition_pass_not_above_markov, B, methodology, PHASE_737, PHASE_738	daiin_chsh_z=4.05. short_sources_surviving=0of6. daiin_ref_z=3.65. ol_ref_p=0.39. sentinel_fidelity_long=0.281. sentinel_fidelity_short=0.996. demotions_stand=C557_C561_C816_C600_C817_C819. correct_null=within_line_token_shuffle.

PHASE_736 DISPOSITIONS (2026-05-29): The "elephant" — is AXM 0.698 self-transition above-composition or mass-artifact? Both experts KILLED the original ablation design (foregone: λ2 dominated by AXM mass + independence-replacement mechanically rigs collapse) and pivoted to per-synth-own-shuffle on the scalar self-transition + submatrix-λ2 + eigenvector-loading falsification + qo->ch/sh gate-zero. PRIMARY = NON-FINDING: AXM self-transition 0.7055, real excess over composition +0.0104, synth +0.0121, z=-0.39, p=0.655 -> a 68pct-mass block self-transitions ~68pct by construction, 5-gram reproduces it. NOT a demotion (C978 text already attributes attractor to "operational mass"; was never registered above-Markov). Gate-zero PASS (qo->chsh z=+3.58). C2065 registers the genuinely-new finding: the macro-slow-mode is DISTRIBUTED (not in the attractor), grounding C1010. C978 ANNOTATED (scope-correction not demotion: self-transition=mass, gap measurement stands, "designed dwell"->"mass-dominant macro-state"). C976/C2061/C1010/C1019/Tier 0 UNTOUCHED; corroborates C1403 (MONOSTATE=thematic dominance). KEY LESSONS: self-transition/dwell scalar is a mass artifact (never infer designed cohesion from high self-rate); above-Markov signal is in eigenstructure, possibly DISTRIBUTED; eigenvector-loading is the cheap falsification for distributed-vs-localized. Naive AXM-block-λ2-vs-5gram (0.222 vs 0.131) EXCLUDED (per-synth-shuffle-violating). Successful pivot: killed a candidate (elephant made of mass), surfaced a real finding (distributed eigenstructure).

C2064	daiin->ch/sh-prefix Bigram Is Above the 5-gram Floor (Measurement-Only, Mechanism Ambiguous). PHASE_735 (2026-05-28). C816 cascade audit (per-synth-own-shuffle 5-gram null, 200 synth, Bonferroni a=0.006). The unconditional daiin->(ch/sh-prefix) transition tendency has real excess +0.2272 vs synth +0.1297, z=4.05, p<0.005 (survives Bonferroni) -- genuine above-Markov bigram, grouped with C549 (qo->ch/sh z=5.79) + C2056 correction-lane family. TWO caveats keep it measurement-only: (1) DENOMINATOR -- unconditional rate (47.9pct) NOT C817's lane-conditional 90.8pct (untested). (2) MECHANISM AMBIGUOUS -- daiin->CHSH survives (z=4.05) but parallel ol->CHSH DEMOTES (z=0.60) despite similar real rates; daiin-survives/ol-demotes is exactly the token-length/char-signature artifact signature (daiin long fixed token char-5-gram routes past poorly like qo; ol short+reproducible). May be "char-5-gram can't route past long tokens" NOT "CC lane-routing designed". Does NOT validate C600/C817 (both demoted). Discriminating test pre-registered (>=2 short CHSH-source tokens survive -> real lane-attraction; else char-artifact). Extends C2062.	2	daiin_chsh_above_5gram, measurement_only, mechanism_ambiguous_tokenlength_vs_routing, unconditional_not_lane_conditional, does_not_validate_C600_C817, B, PHASE_735	real_excess=0.2272. synth_excess=0.1297. z=4.05. ol_to_chsh_z=0.60. ol_derived_to_qo_z=-0.02. token_length_artifact_suspected=yes.

PHASE_735 DISPOSITIONS (2026-05-28): C816 cascade audit (CC-family flagged when C816 demoted PHASE_731). Per-synth-own-shuffle 5-gram null, 200 synth, Bonferroni a=0.006 (8 metrics). RESULT: C816 positional-ordering framework confirmed 5-gram FLOOR (experts' "mostly demote" prediction held). DEMOTIONS Tier 2->3: C600 (CC trigger selectivity -- ol/ol_derived routing Markov-trivial), C817 (CC lane routing -- lane-conditional 90.8pct UNTESTED, ol/ol_derived trivial), C819 (boundary asymmetry -- daiin-initial fails Bonferroni p=0.040, ol_medial small-effect +0.070 not banked). C558 positional sub-claims (daiin-initial, ol-final) DEMOTED Tier 3 but singleton class-structure claim (Class 10/11/12) UNTESTED (wrong instrument) STANDS Tier 2. C816/C874 (already Tier 3) CONFIRMED floor (mean-positions Markov-reproducible). C818 UNTOUCHED Tier 2 (composition claim, not sequential, correctly excluded). C2064 registers daiin->ch/sh bigram measurement-only/ambiguous. C121 49-class system + TIER 0 UNTOUCHED. Reinforces C2062 (local control bigrams real, positional gradients floor) + discipline note: surviving bigram mechanism (routing-design vs token-length char-signature) needs short-source discriminating control. KEY LESSONS: (a) multiple-comparison correction flips daiin-initial survive->demote; (b) token-length confound -- long fixed source tokens survive transition 5-gram tests partly because char-model routes past them poorly, independent of routing design; (c) denominator discipline -- unconditional != lane-conditional.

C2063	C1025 Battery's B3 Forbidden-Suppression Test Is an Idealization-Conformance Test, Not a Fidelity Test. PHASE_734 (2026-05-28). Resolves the C1025 scope-flag from PHASE_733. Added a character-5-gram as a 6th model to the validated C1025 generative-sufficiency battery (M0-M4 reproduced published numbers; 5-gram passes 9.3/15). B3 scores "forbidden violations == 0". The REAL Currier B corpus has 13 forbidden violations (~0.7pct leakage; C1360 ~0.05pct realized, C789 permeability). M2 produces 0 by hard bidirectional suppression -> passes B3. The 5-gram produces 12.8 ~= real's 13 -> fails B3. So M2 passes B3 by being LESS faithful to the real corpus than the 5-gram is -> B3 rewards over-idealization. 4th C1025-battery test-spec correction (cf C1030/C1033/C1034), INVERSE polarity (those too strict on model, B3 too lenient on over-idealized model). Consequence: M2's advertised +0.1-test edge over M1 was concentrated in B3 (idealization) + B5 (which M2 FAILS); M1 (pure 49-class Markov, no forbidden suppression) is the corpus-FIDELITY frontier, and the macro-automaton topology lives in the class-Markov matrix itself -> forbidden suppression is a thin idealizing overlay (C622 0.12pct buffer, C997 sparse-critical-buffer, C1023 PREFIX-routing sole load-bearing macro component), NOT load-bearing for topology. Consistent with C2060. C1025 RESCOPED (Tier 2 stays): "80pct sufficiency" = 10/15 marginal-floor (M0 i.i.d. passes too) + B1 macro-eigenstructure (single clean above-char-Markov earn = C2061) + B3 idealization + B4/C2/B5 test-spec issues. C978 ANNOTATED: 6-state spectral gap robust to 5-gram null (5-gram fails at 0.947-0.956 vs 0.894; hallucination only 1.6pct, survives drop-unmapped/vocab-constrained but BORDERLINE 45pct pass) -> lead with C2061 (raw-49 λ2 merge-free p=0.000), 6-state B1 corroborates but projection-dependent. char-5-gram NOT strictly > M0 (fails A2/A4 via novel-token hallucination). Tier 0 + 49-class partition UNTOUCHED.	2	B3_idealization_not_fidelity, M2_over_suppresses, M1_is_fidelity_frontier, forbidden_thin_overlay, fourth_C1025_test_spec_correction_inverse, char5gram_not_stronger_than_M0, B, PHASE_734	b3_test=violations_eq_0. real_violations=13. m2_violations=0. fivegram_violations=12.8. fivegram_passes=9.3of15. hallucination_rate=0.016. sixstate_gap_5gram=0.947. real_gap=0.894. m1_fidelity_frontier=yes.

PHASE_733 DISPOSITIONS (2026-05-28): First 5-gram-null test of class-layer structure (C2023). Chained controls each caught the previous confound: (1) naive 5-gram real-I 0.264 vs synth 0.221 z=+3.83 = FALSE POSITIVE (composition-fidelity artifact); (2) per-synth-own-shuffle (rigorous): real excess +0.0485 vs synth +0.0421 p=0.21 -> C2023 scalar class-MI 5-gram-REPRODUCIBLE -> FAILS; (3) partition-ARI through C976 merge CONFOUNDED by hardcoded role/depletion constraints (random null ARI 0.669); (4) clean lambda2 spectral test: real 0.206 vs 5-gram 0.119 at shuffle floor -> macro-eigenstructure SURVIVES; (5) lambda2 excess symmetry control p=0.000. DISPOSITION: C2023 class-layer SCALAR-MI half DEMOTED Tier 2->3 (joins C1727/C645 as shuffle-survivor failing 5-gram); MIDDLE-layer + forbidden-pair findings unaffected. C2061 vindicates C976-C978 macro-automaton at eigenstructure level. C2062 three-axis decomposition. C1025 (M2) scope-flag (scalar metrics partly 5-gram-floor, topological real, no demote). C121/C124 49-class partition + TIER 0 UNTOUCHED. CASCADE STOPPED at C2023. KEY RECONCILIATION: scalar MI reproduced but lambda2 not = coherent (scalar = high-mass lumped functional dominated by local bigrams; lambda2 = global community structure 5-gram can't reproduce). Methodology: per-synth-own-baseline mandatory; algorithm-mediated metrics confounded (floor-control or bypass); scalar aggregate != eigenstructure. Memory feedback_chained_controls_scalar_vs_eigenstructure.md.

PHASE_732 DISPOSITIONS (2026-05-28): Forbidden-pair 5-gram audit + hazard-class provenance correction. The audit (17 forbidden pairs at MIDDLE/token layer) was confirmatory of C2023 (tested the layer C2023 already showed is co-occurrence-only z=-0.39; load-bearing structure is at 49-class projection z=+3.91, never 5-gram tested): 7 WEAK above-Markov (CONFOUNDED by 5-gram under-production ~33% median, range 0.32-8.86x), 6 MARKOV_TRIVIAL, 4 PHANTOM (he/ee = 0 corpus occurrences). Categorical claim (forbidden=0% vs freq-matched controls 0.3-6%) robust = C627 token-specific. Within-class anomaly test re-derived C629/C630 (class 23 heterogeneity token-specific not miscategorization). HEADLINE (C2060): user asked if 5 hazard classes derived from forbidden transitions -> triple-confirmed IMPOSED by hardcoded keyword dict, not clustered. C109 revised existence-only (detail-file header corrected: was wrongly "Tier 0 FROZEN", canonical INDEX=Tier 2). C216 DEMOTED Tier 2->3. C110/C111/C112 KEPT. C1528-C1533 UNTOUCHED (surviving rigorous atom layer). Tier 0 UNTOUCHED. New failure pattern #9 (phantom-clustering) -> feedback_phantom_clustering_provenance_audit.md. Second early-phase audit-correction after C131. KEY LESSON: caught only by reading derivation SOURCE not constraint text; separate "imposed vs discovered" (provenance) from "captures real structure" (validity) — both held here (imposed AND atom-cohesive-but-not-5).

PHASE_731 DISPOSITIONS (2026-05-28): First 5-gram null audit batch of PHASE_729 suspect-zone constraints. 5 audited, 2 strong survivors, 3 demotions Tier 2->3. Positive control C2056 passed at p=0.030 after 2-cycle methodology calibration (PHASE_729 enrichment-over-shuffle metric didn't translate to raw rate; switched to p_emp-primary verdicts). SURVIVORS: (a) C549 SURVIVES STRONG (qo->ch/sh interleaving real 29.2% vs synth 25.0%, p=0.000, z=5.79) — above-Markov bigram selection, reinforces C1313/C1314/C2056. (b) C562 SURVIVES STRONG (ary 100% line-final real 16/16 vs synth 11.86%, p=0.000, z=10.25, residual +88pp) — categorical positional grammar, reinforces C485/C1486/C1487/C539 LATE-class. DEMOTIONS: (c) C557 DEMOTED Tier 2->3 (daiin line-initial 27.07% vs synth 23.64%, p=0.085) — measurement preserved, "unique control signal" mechanism Markov-trivial. (d) C561 DEMOTED Tier 2->3 (or->aiin M1 17.43% vs synth 13.61% at N=1000 p=0.064; aiin->aiin M2 0% real vs 0.35% synth both near-zero) — measurements preserved, "directional grammatical unit" mechanism retracts; strengthens C627 correct framing. (e) C816 DEMOTED Tier 2->3 (all 3 sub-measurements: daiin mean-pos p=0.86, ol mean-pos p=0.88, differential p=0.43) — positional means preserved as descriptive, "daiin initiates loop" mechanism Markov-reproducible. CASCADE FLAGS (PENDING_REAUDIT, not retracted): C544/C558/C874 from C557; C544+C627strength from C561; C817/C818/C874/C600/C558/C819 from C816 (CC family). TIER 0 UNCHANGED (closed-loop control programs grounded in C074/C079/C084/C109/C627/C121/C124/C976-C978/C1025/C1394, independent of C816 mechanism). DEMOTION RATE 60% below 67-83% expert prediction — batch included 2 categorical-exclusion claims (C549/C562) that survived against expert prior. METHODOLOGY REFINEMENT REGISTERED in feedback_5gram_markov_null_for_surface_patterns.md: distinguish frequency claims (>95%-<100%, often Markov-reproducible, high suspicion) from categorical exclusions (exact 100%/0% with structural backing, often above-Markov, lower suspicion); bimodal expert prior. C562 expert prediction miss = teaching case. OUTSTANDING: Batch 2 forbidden-pair audit (C109/C627 individually) is highest-stakes test per crazy-expert; Batch 3 C816 cascade family.

PHASE_730 DISPOSITIONS (2026-05-28): Three findings registered (C2057, C2058, C2059). One major framework-as-null catch — proposed state/action o-selectivity mechanism story killed before registration. Original within-A Finding 1 (95% A state-form vs 21% B action-form, p=0.000 against within-folio shuffle null) plus per-MIDDLE example (ke 0% dy in A, 67% dy in B) generated clean operational story: "A=setup, B=execute via arrangement-selective dy-completion on o-containing MIDDLEs." Within-A action-form discriminating test (pre-registered): H1 PASS at 38.9% (A IS grammatically capable of dy — 21 of 54 dy-eligible MIDDLEs appear in dy-form somewhere in A; architectural-tautology hypothesis falsified) + H2 FAIL at p=0.51 (positional deployment not the axis) = AMBIGUOUS. Post-hoc o-content split prompted proposed confirmation test; expert-advisor + crazy-expert audit flagged six design flaws (post-hoc fig leaf, frequency confound, structural-domain confound, B-side mirror missing, HEAD vs ANY predicate ambiguity, C1557 cross-check unaddressed, framework-echo). B-side mirror: B symmetric across o vs non-o (Mann-Whitney one-sided p=0.62) — confirms A asymmetry IS A-specific. Terminal-atom-matched permutation null: stratified diff -0.016, p=0.71 — o-content effect collapses. Real driver: terminal-atom phonotactics — MIDDLEs ending in o/l dy-permitted in A (mean 0.39-0.56); MIDDLEs ending in e/h suppressed (mean 0-0.09) — regardless of o-content elsewhere. o-HEAD MIDDLEs ALSO dy-suppressed in A (mean 0.026). FIFTH framework-as-null trap caught in 2026-05 (after k-e-depth thermal regimes, triple-i iteration, hh intense-monitoring, f66r-glossary). Residual observation — "A gates dy attachment by terminal-atom; B does not" — is real but post-hoc; tabled for fresh pre-registration on held-out scope.

C2054	Physics-Architectural Matcher Achieves Three-Class Discrimination Within Medieval Procedural Latin (Latin-Side Instrument Calibration). PHASE_723 Phase 1-3 (2026-05-21). After PHASE_718 showed 8D matcher generic at text-feature-density level, built NEW matcher with hand-tuned features designed from physics-architecture: apparatus markers (alembic, cucurbita, distillatorium vs incus, malleus, tenax), phase-transition operations (distill, sublim, condens, evapor vs fund, conflat, cud, trah), reversibility markers (revert, restaur, iter, circul vs durus, indurat, rigid). Ambiguous terms (fornax, crucibulum, ignis, aqua, aurum) EXCLUDED. Phase 1-2: 4/5 pre-reg PASS (Codicillus +0.0152 ✓, Theophilus -0.0052 ✓, gap 0.0204 > 0.010 ✓, Mann-Whitney p=0.00000 ✓; Rupescissa +0.0005 neutral, FAIL on predicted positive). Phase 3 (full Pseudo-Lull Testamentum, 336 paras, 13655 words via 15-80 filter): 3/3 pre-reg PASS (discrimination +0.0077 ✓, within 0.0075 of Codicillus subset ✓, Mann-Whitney vs Theophilus p<10^-5 ✓). Mesue pharmacy -0.0004 (neutral). Three-class discrimination emerged: (1) operational distillation POSITIVE (Codicillus, full Testamentum); (2) theoretical-alchemy + pharmacy NEUTRAL (Rupescissa, Mesue); (3) metalwork NEGATIVE (Theophilus). Rupescissa neutral is interpretive refinement — matcher discriminates OPERATIONAL distillation specifically, not distillation-as-content-domain. LATIN-SIDE INSTRUMENT CALIBRATION ONLY. Demonstrates physics-architectural feature design CAN discriminate Latin domains where text-feature-density features (8D matcher per PHASE_718) cannot. Refines PHASE_718 finding from "8D matcher generic" to "8D matcher's specific text-feature-density approach is generic; physics-architectural feature design discriminates". Does NOT yet say anything about Voynich. Phase 4 (Voynich-side mapping) BLOCKED — both experts converged: proposed mapping uses C1314, C645+C2045, C2042 as analog features, but those constraints were DERIVED FROM Voynich substrate observations. Using them as positive features for "Voynich is distillation" would be tautological per feedback_framework_as_null.md. Crazy-expert: "Phase 4 as designed cannot produce a non-trivial PASS." Phase 4 requires decoupled feature design (Voynich-side features defined a priori from external Latin features, NOT existing Voynich constraints). Caveats: Codicillus complete_latin.txt has English commentary contamination; Testamentum 15-80 filter drops ~90% of total content; hand-curated markers may be biased.	2	physics_architectural_feature_design, three_class_discrimination_within_latin, operational_distillation_vs_theoretical_vs_metalwork, latin_side_instrument_calibration_only, Voynich_classification_NOT_established, Phase_4_blocked_on_framework_as_null, refines_PHASE_718_finding, Codicillus, Testamentum, Theophilus, Mesue, Rupescissa	n_codicillus_paras=148. n_testamentum_paras=336. n_theophilus_paras=144. codicillus_discrimination=+0.0152. testamentum_discrimination=+0.0077. theophilus_discrimination=-0.0052. rupescissa_discrimination=+0.0005_neutral. mesue_discrimination=-0.0004_neutral. mann_whitney_codicillus_theophilus_p=0.00000. mann_whitney_testamentum_theophilus_p_lt_10minus5. phase_1_2_pass=4_of_5. phase_3_pass=3_of_3. three_class_structure=operational_distillation_positive_neutral_metalwork_negative. Voynich_NOT_classified=yes. Phase_4_blocked_framework_as_null=yes. expert_convergence_proposed_mapping_uses_voynich_derived_constraints=yes. requires_decoupled_feature_design=yes. english_contamination_caveat=documented. testamentum_filter_drops_90_percent=documented.
...
## feedback-window-blindness-wrong-instrument

*"The char-Markov (5-gram) null is the WRONG INSTRUMENT for token-adjacency / prefix-routing claims — it is window-blind to a long source token's prefix at the boundary, so transition-survival from long low-fidelity tokens is a source-ungeneratability artifact, not structure. A verdict that flips with source-token length is windowing. Composition-control (token-shuffle) pass ≠ above-Markov; don't upgrade the label."*

# Window-blindness: char-Markov is the wrong instrument for token-adjacency (PHASE_737/738, C2066)

The 5-gram-null audit thread (PHASE_729+) treats the char-5-gram as "the sharpest null." PHASE_737/738 found the one claim-class where it is the WRONG instrument, and the episode produced three reusable discipline rules.
