...
The context system contains 862 validated constraints. Before answering ANY question about Voynich structure, relationships, or behavior:
...
├── CLAIMS/              ← 862 constraints (INDEX + files)
...
**Why this matters:** The expert-advisor has all 862 constraints embedded in its system prompt. Delegation runs in isolated context, avoiding context bloat.
---
