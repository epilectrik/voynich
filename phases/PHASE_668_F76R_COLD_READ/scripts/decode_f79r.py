"""
Full atom-level decode of f79r against matched recipe III.12
(mercury sublimation -> elixir)
"""
import sys, io, json
...
out_path = REPO_ROOT / 'phases' / 'PHASE_668_F76R_COLD_READ' / 'results' / 'f79r_decode_summary.json'
