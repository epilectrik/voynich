"""
Full atom-level decode of f103r against matched recipe III.16
(ferment multiplication, multi-chamber)
"""
import sys, io, json
...
out_path = REPO_ROOT / 'phases' / 'PHASE_668_F76R_COLD_READ' / 'results' / 'f103r_decode_summary.json'
