...
def main():
    ...
    # ================================================================
    # CCS1 reduction (from T2 profile summary)
    # ================================================================
    print("\n--- CCS1 reduction ---")
    profile_summary = t2_gated.get('profile_summary', {}).get(best_config, {})
